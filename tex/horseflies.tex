...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb31}{, 31}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
...
\NWtarget{nuweb32a}{} $\langle\,${\itshape Set log, algo-state and input-output files config}\nobreak\ {\footnotesize {32a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@io_file_name,@\nobreak\ \NWlink{nuweb33c}{33c}, \verb@logger@\nobreak\ \NWlink{nuweb32b}{32b}\NWlink{nuweb33a}{, 33a}\NWlink{nuweb33b}{b}\NWlink{nuweb33c}{c}\NWlink{nuweb34}{, 34}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb32b}{} $\langle\,${\itshape Set insertion policy class for current run}\nobreak\ {\footnotesize {32b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb33a}{} $\langle\,${\itshape Use insertion policy to find the cheapest site to insert into current tour}\nobreak\ {\footnotesize {33a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb33b}{} $\langle\,${\itshape Write algorithm's current state to file}\nobreak\ {\footnotesize {33b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb33c}{} $\langle\,${\itshape Write input and output to file}\nobreak\ {\footnotesize {33c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@with open(dir_name + '/' + io_file_name, 'w') as outfile:@\\
\mbox{}\verb@     yaml.dump( data, \@\\
\mbox{}\verb@                outfile, \@\\
\mbox{}\verb@                default_flow_style=False)@\\
\mbox{}\verb@logger.debug("Dumped input and output to " + io_file_name)@\\
\mbox{}\verb@@\\
\mbox{}\verb@# Read back the data for a quick sanity-check@\\
\mbox{}\verb@# of result before returning answer. @\\
\mbox{}\verb@import utils_algo@\\
\mbox{}\verb@with open(dir_name + '/' + io_file_name, 'r') as stream:@\\
\mbox{}\verb@     data_loaded = yaml.load(stream)@\\
\mbox{}\verb@print '\n--------------------------------------------'@\\
\mbox{}\verb@print "INITIAL HORSEPOSITION "@\\
\mbox{}\verb@print data_loaded['inithorseposn']@\\
\mbox{}\verb@print '\n--------------------------------------------'@\\
\mbox{}\verb@print "SPEED RATIO"@\\
\mbox{}\verb@print data_loaded['phi']@\\
\mbox{}\verb@print '\n--------------------------------------------'@\\
\mbox{}\verb@print "HORSE TOUR"@\\
\mbox{}\verb@utils_algo.print_list(data_loaded['horse_tour'])@\\
\mbox{}\verb@print '\n--------------------------------------------'@\\
\mbox{}\verb@print "VISITED SITES ARE"@\\
\mbox{}\verb@utils_algo.print_list(data_loaded['visited_sites'])@\\
\mbox{}\verb@print '\n--------------------------------------------'@\\
\mbox{}\verb@logger.debug("Reading back data from files printed out for sanity-check of data-written")@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb31}{31}.
\item \NWtxtIdentsUsed\nobreak\  \verb@io_file_name,@\nobreak\ \NWlink{nuweb32a}{32a}, \verb@logger@\nobreak\ \NWlink{nuweb32a}{32a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb34}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {34}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb31}{31}.
\item \NWtxtIdentsUsed\nobreak\  \verb@logger@\nobreak\ \NWlink{nuweb32a}{32a}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb41a}{41a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb35a}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {35a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb35a}{35a}\NWlink{nuweb35b}{b}\NWlink{nuweb36}{, 36}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb31}{31}.
\item \NWtxtIdentsDefed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb35b}{35b}\NWlink{nuweb36}{, 36}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb35b}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {35b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb36}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {36}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Define various insertion policy classes}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb31}{31}.
\item \NWtxtIdentsDefed\nobreak\  \verb@self.horse_tour@\nobreak\ \NWlink{nuweb39b}{39b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb24}{24}\NWlink{nuweb38a}{, 38a}\NWlink{nuweb38c}{c}\NWlink{nuweb39b}{, 39b}, \verb@self.sites,@\nobreak\ \NWlink{nuweb24}{24}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb38a}{38a}\NWlink{nuweb39b}{, 39b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb38c}{38c}\NWlink{nuweb39a}{, 39a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb38a}{} $\langle\,${\itshape Compute the length of the tour that currently services the visited sites}\nobreak\ {\footnotesize {38a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsDefed\nobreak\  \verb@current_tour_length@\nobreak\ \NWlink{nuweb38c}{38c}.\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb35b}{35b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb37a}{37a}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb37a}{37a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb38b}{} $\langle\,${\itshape Set up tracking variables local to this iteration}\nobreak\ {\footnotesize {38b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ibest                = 0@\\
...
\NWtarget{nuweb38c}{} $\langle\,${\itshape If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}}\nobreak\ {\footnotesize {38c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb37b}{37b}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb35b}{35b}, \verb@current_tour_length@\nobreak\ \NWlink{nuweb38a}{38a}, \verb@delta_increase_least@\nobreak\ \NWlink{nuweb38b}{38b}, \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb37b}{37b}, \verb@ibest,@\nobreak\ \NWlink{nuweb38b}{38b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb37a}{37a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb39a}{} $\langle\,${\itshape Find the unvisited site which on insertion increases tour-length by the least amount}\nobreak\ {\footnotesize {39a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb39b}{} $\langle\,${\itshape Update states for \texttt{PolicyNaive}}\nobreak\ {\footnotesize {39b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb37b}{37b}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour@\nobreak\ \NWlink{nuweb36}{36}, \verb@self.horse_tour@\nobreak\ \NWlink{nuweb37a}{37a}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb37a}{37a}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb37a}{37a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb40}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {40}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb40}{40}\NWlink{nuweb41a}{, 41a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}\NWlink{nuweb41b}{, 41b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41a}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {41a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb40}{40}\NWlink{nuweb41a}{, 41a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb28}{28}\NWlink{nuweb34}{, 34}\NWlink{nuweb41b}{, 41b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41b}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {41b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb31}{, 31}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Compute the length of the tour that currently services the visited sites\nobreak\ {\footnotesize \NWlink{nuweb38a}{38a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb37b}{37b}.}
\item $\langle\,$Define auxiliary helper functions\nobreak\ {\footnotesize \NWlink{nuweb35a}{35a}\NWlink{nuweb35b}{b}\NWlink{nuweb36}{, 36}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb31}{31}.}
...
\item $\langle\,$Define various insertion policy classes\nobreak\ {\footnotesize \NWlink{nuweb37a}{37a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb31}{31}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb40}{40}\NWlink{nuweb41a}{, 41a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb41b}{41b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Set up tracking variables local to this iteration\nobreak\ {\footnotesize \NWlink{nuweb38b}{38b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb37b}{37b}.}
...
\item $\langle\,$Update states for \texttt{PolicyNaive}\nobreak\ {\footnotesize \NWlink{nuweb39b}{39b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb37b}{37b}.}
...
\item \verb@algo_greedy_incremental_insertion@: \NWlink{nuweb21b}{21b}, \underline{\NWlink{nuweb31}{31}}.
\item \verb@compute_collinear_horseflies_tour@: \underline{\NWlink{nuweb36}{36}}\NWlink{nuweb39b}{, 39b}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb35b}{35b}}\NWlink{nuweb38a}{, 38a}\NWlink{nuweb38c}{c}.
\item \verb@current_tour_length@: \underline{\NWlink{nuweb38a}{38a}}\NWlink{nuweb38c}{, 38c}.
\item \verb@delta_increase_least@: \underline{\NWlink{nuweb38b}{38b}}\NWlink{nuweb38c}{, 38c}.
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb37b}{37b}}\NWlink{nuweb38c}{, 38c}\NWlink{nuweb39a}{, 39a}.
\item \verb@HorseFlyInput@: \NWlink{nuweb23b}{23b}, \underline{\NWlink{nuweb24}{24}}.
\item \verb@ibest,@: \underline{\NWlink{nuweb38b}{38b}}\NWlink{nuweb38c}{, 38c}.
\item \verb@io_file_name,@: \underline{\NWlink{nuweb32a}{32a}}\NWlink{nuweb33c}{, 33c}.
\item \verb@logger@: \underline{\NWlink{nuweb32a}{32a}}\NWlink{nuweb32b}{, 32b}\NWlink{nuweb33a}{, 33a}\NWlink{nuweb33b}{b}\NWlink{nuweb33c}{c}\NWlink{nuweb34}{, 34}.
\item \verb@plotTour@: \NWlink{nuweb21b}{21b}, \underline{\NWlink{nuweb41b}{41b}}.
\item \verb@run_handler@: \underline{\NWlink{nuweb20a}{20a}}.
\item \verb@self.horse_tour@: \underline{\NWlink{nuweb37a}{37a}}\NWlink{nuweb39b}{, 39b}.
\item \verb@self.inithorseposn,@: \NWlink{nuweb24}{24}, \underline{\NWlink{nuweb37a}{37a}}\NWlink{nuweb38a}{, 38a}\NWlink{nuweb38c}{c}\NWlink{nuweb39b}{, 39b}.
\item \verb@self.sites,@: \NWlink{nuweb24}{24}, \underline{\NWlink{nuweb37a}{37a}}.
\item \verb@self.visited_sites,@: \underline{\NWlink{nuweb37a}{37a}}\NWlink{nuweb38a}{, 38a}\NWlink{nuweb39b}{, 39b}.
\item \verb@single_site_solution@: \underline{\NWlink{nuweb35a}{35a}}\NWlink{nuweb35b}{, 35b}\NWlink{nuweb36}{, 36}.
\item \verb@tour_length@: \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}, \underline{\NWlink{nuweb40}{40}}\NWlink{nuweb41b}{, 41b}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb28}{28}\NWlink{nuweb34}{, 34}, \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb41b}{, 41b}.
