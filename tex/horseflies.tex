...
\NWtarget{nuweb84b}{} $\langle\,${\itshape Set up configurations and parameters for animation and plotting}\nobreak\ {\footnotesize {84b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@plt.rc('text', usetex=True)@\\
...
\NWtarget{nuweb85a}{} $\langle\,${\itshape Parse \verb|horse_trajectory| and \verb|fly_trajectories| and extract \verb|x| and \verb|y| coordinates along trajectories}\nobreak\ {\footnotesize {85a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@xhs = [ horse_trajectory[i][0][0] for i in range(len(horse_trajectory))]    @\\
...
\NWtarget{nuweb85b}{} $\langle\,${\itshape Construct and store every frame of the animation in \verb|ims|}\nobreak\ {\footnotesize {85b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@     flies_posns = map(discretize_leg(fly_leg)) @\\
\mbox{}\verb@    @\\
\mbox{}\verb@     # all points on horse trajectory uptil the beginning of the current-leg@\\
\mbox{}\verb@     hxs = [xhs[i] for i in range(0,leg_idx+1) ]@\\
\mbox{}\verb@     hys = [yhs[i] for i in range(0,leg_idx+1) ]@\\
\mbox{}\verb@ @\\
\mbox{}\verb@     # all points on fly trajectories uptil the beginning of the current-leg@\\
\mbox{}\verb@     fxss = []@\\
\mbox{}\verb@     fyss = []@\\
\mbox{}\verb@     for i in range(number_of_flies):@\\
\mbox{}\verb@        fxss.extend( [ fly_leg[0][0] for fly_leg, j in zip(flies_legs[i], range(0, leg_idx+1)) if fly_leg != None] )@\\
\mbox{}\verb@        fyss.extend( [ fly_leg[0][1] for fly_leg, j in zip(flies_legs[i], range(0, leg_idx+1)) if fly_leg != None] )@\\
\mbox{}\verb@@\\
\mbox{}\verb@          sys.exit()@\\
\mbox{}\verb@@{\NWsep}
\end{list}
...
\NWtarget{nuweb86}{} $\langle\,${\itshape Extract the list of horse and fly legs along the horse and fly trajectories respectively}\nobreak\ {\footnotesize {86}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb87a}{} $\langle\,${\itshape Define function to place points along a leg}\nobreak\ {\footnotesize {87a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@def discretize_leg(pts):@\\
\mbox{}\verb@   print Fore.YELLOW, pts, Style.RESET_ALL@\\
\mbox{}\verb@   subleg_pts = []@\\
\mbox{}\verb@   numpts     = len(pts)@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@       k  = 10 @\\
\mbox{}\verb@   else: # pts is None@\\
\mbox{}\verb@       return None  # fly-leg is empty, nothing to discretize@\\
\mbox{}\verb@@\\
\mbox{}\verb@   for p,q in zip(pts, pts[1:]):@\\
\mbox{}\verb@    print Fore.RED, p, q, Style.RESET_ALL@\\
\mbox{}\verb@       tmp = []@\\
\mbox{}\verb@       for t in np.linspace(0,1,k): @\\
\mbox{}\verb@           tmp.append( (1-t)*p + t*q ) @\\
\mbox{}\verb@       subleg_pts.extend(tmp[:-1])@\\
...
\NWtarget{nuweb87b}{} $\langle\,${\itshape Render frame and append it to \verb|ims|}\nobreak\ {\footnotesize {87b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb87c}{} $\langle\,${\itshape Write animation of tour to disk and display in live window}\nobreak\ {\footnotesize {87c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@from colorama import Back @\\
\mbox{}\verb@@\\
...
\item $\langle\,$Construct and store every frame of the animation in \verb|ims|\nobreak\ {\footnotesize \NWlink{nuweb85b}{85b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84a}{84a}.}
...
\item $\langle\,$Define function to place points along a leg\nobreak\ {\footnotesize \NWlink{nuweb87a}{87a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb85b}{85b}.}
...
\item $\langle\,$Render frame and append it to \verb|ims|\nobreak\ {\footnotesize \NWlink{nuweb87b}{87b}}$\,\rangle$ {\footnotesize {\NWtxtNoRef}.}
...
\item $\langle\,$Write animation of tour to disk and display in live window\nobreak\ {\footnotesize \NWlink{nuweb87c}{87c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84a}{84a}.}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@animate_tour@: \NWlink{nuweb82b}{82b}, \underline{\NWlink{nuweb84a}{84a}}.
