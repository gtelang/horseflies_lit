...
\NWtarget{nuweb11a}{} \verb@"../main.py"@\nobreak\ {\footnotesize {11a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb11b}{} $\langle\,${\itshape Turn off Matplotlib's irritating DEBUG messages}\nobreak\ {\footnotesize {11b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb11c}{} $\langle\,${\itshape Import problem module files}\nobreak\ {\footnotesize {11c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb13}{} \verb@"../src/lib/utils_graphics.py"@\nobreak\ {\footnotesize {13}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb13}{13}\NWlink{nuweb14a}{, 14a}\NWlink{nuweb14b}{b}\NWlink{nuweb15}{, 15}.
...
\NWtarget{nuweb14a}{} \verb@"../src/lib/utils_graphics.py"@\nobreak\ {\footnotesize {14a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb14b}{} \verb@"../src/lib/utils_graphics.py"@\nobreak\ {\footnotesize {14b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb16a}{} \verb@"../src/lib/utils_algo.py"@\nobreak\ {\footnotesize {16a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import numpy as np@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb16a}{16a}\NWlink{nuweb16b}{b}\NWlink{nuweb17a}{, 17a}\NWlink{nuweb17b}{b}\NWlink{nuweb18}{, 18}.
...
\NWtarget{nuweb16b}{} \verb@"../src/lib/utils_algo.py"@\nobreak\ {\footnotesize {16b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb18}{} \verb@"../src/lib/utils_algo.py"@\nobreak\ {\footnotesize {18}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb21c}{} $\langle\,${\itshape Start entering input from the command-line}\nobreak\ {\footnotesize {21c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb28}{28}, \verb@algo_greedy_incremental_insertion,@\nobreak\ \NWlink{nuweb32a}{32a}, \verb@plotTour@\nobreak\ \NWlink{nuweb47}{47}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@HorseFlyInput@\nobreak\ \NWlink{nuweb24c}{24c}, \verb@wrapperkeyPressHandler@\nobreak\ \NWlink{nuweb21b}{21b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb24c}{} $\langle\,${\itshape Local data-structures for classic horsefly}\nobreak\ {\footnotesize {24c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@HorseFlyInput@\nobreak\ \NWlink{nuweb24b}{24b}.\item \NWtxtIdentsUsed\nobreak\  \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb40a}{40a}, \verb@self.sites,@\nobreak\ \NWlink{nuweb40a}{40a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb26}{} $\langle\,${\itshape Algorithms for classic horsefly}\nobreak\ {\footnotesize {26}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb32a}{, 32a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb28}{28}, \verb@tour_length@\nobreak\ \NWlink{nuweb46a}{46a}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb32a}{, 32a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb21c}{21c}\NWlink{nuweb26}{, 26}\NWlink{nuweb27}{, 27}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb46a}{46a}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb46b}{46b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb32a}{, 32a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_greedy_incremental_insertion,@\nobreak\ \NWlink{nuweb21c}{21c}, \verb@write_algo_states_to_disk_p@\nobreak\ \NWlink{nuweb34a}{34a}\NWlink{nuweb34b}{b}\NWlink{nuweb37b}{, 37b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb32b}{} $\langle\,${\itshape Set log, algo-state and input-output files config}\nobreak\ {\footnotesize {32b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\NWtarget{nuweb33a}{} $\langle\,${\itshape Set insertion policy class for current run}\nobreak\ {\footnotesize {33a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb33b}{} $\langle\,${\itshape Use insertion policy to find the cheapest site to insert into current tour}\nobreak\ {\footnotesize {33b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb34a}{} $\langle\,${\itshape Write algorithm's current state to file}\nobreak\ {\footnotesize {34a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb34b}{} $\langle\,${\itshape Render current algorithm state to image file}\nobreak\ {\footnotesize {34b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@import utils_algo@\\
\mbox{}\verb@if write_algo_states_to_disk_p:@\\
...
\mbox{}\verb@     @\hbox{$\langle\,${\itshape Write image file}\nobreak\ {\footnotesize \NWlink{nuweb36e}{36e}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb34c}{} $\langle\,${\itshape Set up plotting area and canvas, fig, ax, and other configs}\nobreak\ {\footnotesize {34c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb35a}{} $\langle\,${\itshape Extract $x$ and $y$ coordinates of the points on the horse, fly tours, visited and unvisited sites}\nobreak\ {\footnotesize {35a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb35b}{} $\langle\,${\itshape Mark initial position of horse and fly boldly on canvas}\nobreak\ {\footnotesize {35b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ax.add_patch( mpl.patches.Circle( inithorseposn, \@\\
...
\NWtarget{nuweb36a}{} $\langle\,${\itshape Draw horse and fly-tours}\nobreak\ {\footnotesize {36a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36b}{} $\langle\,${\itshape Place numbered markers on visited sites to mark the order of visitation explicitly}\nobreak\ {\footnotesize {36b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36c}{} $\langle\,${\itshape Draw unvisited sites as filled blue circles}\nobreak\ {\footnotesize {36c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36d}{} $\langle\,${\itshape Give metainformation about current picture as headers and footers}\nobreak\ {\footnotesize {36d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36e}{} $\langle\,${\itshape Write image file}\nobreak\ {\footnotesize {36e}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Write input and output to file}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Make an animation of algorithm states, if \verb|write_algo_states_to_disk_p == True|}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@if write_algo_states_to_disk_p:@\\
...
\NWtarget{nuweb38a}{} $\langle\,${\itshape Make an animation of the schedule, if \verb|animate_schedule_p == True|}\nobreak\ {\footnotesize {38a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb38b}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {38b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb38c}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {38c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb38c}{38c}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb39a}{39a}\NWlink{nuweb39b}{b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb39a}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {39a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb38c}{38c}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb41a}{41a}\NWlink{nuweb41c}{c}.\item \NWtxtIdentsUsed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb38c}{38c}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb39b}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {39b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb38c}{38c}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@compute_collinear_horseflies_tour@\nobreak\ \NWlink{nuweb42}{42}.\item \NWtxtIdentsUsed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb38c}{38c}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb40a}{} $\langle\,${\itshape Define various insertion policy classes}\nobreak\ {\footnotesize {40a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@self.horse_tour@\nobreak\ \NWlink{nuweb42}{42}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb24c}{24c}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41c}{c}\NWlink{nuweb42}{, 42}, \verb@self.sites,@\nobreak\ \NWlink{nuweb24c}{24c}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb41a}{41a}\NWlink{nuweb42}{, 42}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb40b}{} $\langle\,${\itshape Methods for \verb|PolicyBestInsertionNaive|}\nobreak\ {\footnotesize {40b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb41c}{41c}\NWlink{nuweb41d}{d}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41a}{} $\langle\,${\itshape Compute the length of the tour that currently services the visited sites}\nobreak\ {\footnotesize {41a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsDefed\nobreak\  \verb@current_tour_length@\nobreak\ \NWlink{nuweb41c}{41c}.\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb39a}{39a}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb40a}{40a}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb40a}{40a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41b}{} $\langle\,${\itshape Set up tracking variables local to this iteration}\nobreak\ {\footnotesize {41b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ibest                = 0@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb40b}{40b}.
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least@\nobreak\ \NWlink{nuweb41c}{41c}, \verb@ibest,@\nobreak\ \NWlink{nuweb41c}{41c}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41c}{} $\langle\,${\itshape If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}}\nobreak\ {\footnotesize {41c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb40b}{40b}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb39a}{39a}, \verb@current_tour_length@\nobreak\ \NWlink{nuweb41a}{41a}, \verb@delta_increase_least@\nobreak\ \NWlink{nuweb41b}{41b}, \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb40b}{40b}, \verb@ibest,@\nobreak\ \NWlink{nuweb41b}{41b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb40a}{40a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41d}{} $\langle\,${\itshape Find the unvisited site which on insertion increases tour-length by the least amount}\nobreak\ {\footnotesize {41d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb42}{} $\langle\,${\itshape Update states for \texttt{PolicyBestInsertionNaive}}\nobreak\ {\footnotesize {42}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
tree on the set of sites. This process is animated in \autoref{fig:animating-growth-of-phi-prim-mst}
...
(\url{https://scikit-learn.org/stable/modules/neighbors.html}). When porting my codes to C\texttt{++}
I will probably have to switch over to the Boost Graph library and David Mount's ANN for the same purposes. 

\begin{flushleft} \small
\begin{minipage}{\linewidth}\label{scrap53}\raggedright\small
\NWtarget{nuweb44a}{} $\langle\,${\itshape Lower bounds for classic horsefly}\nobreak\ {\footnotesize {44a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\newchunk As you can see in the previous chunk,  
\begin{flushleft} \small
\begin{minipage}{\linewidth}\label{scrap54}\raggedright\small
\NWtarget{nuweb44b}{} $\langle\,${\itshape Set \verb|phi_prim_mst| to the singleton graph, with node coordinates set at \verb|inithorseposn|}\nobreak\ {\footnotesize {44b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@print "Hello World"@\\
\mbox{}\verb@i = 0@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb44c}{} $\langle\,${\itshape For each node in current $\varphi$-Prim-MST compute the closest unmarked site}\nobreak\ {\footnotesize {44c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb44d}{} $\langle\,${\itshape Get the node $M^{*}$ with the closest unmarked site $S^{*}$ from the previous step}\nobreak\ {\footnotesize {44d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb45a}{} $\langle\,${\itshape Compute the rendezvous point $R$ along $M^{*}S^{*}$}\nobreak\ {\footnotesize {45a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb45b}{} $\langle\,${\itshape Mark site $S$, add node $R$ and edge $MR$ to the existing $\varphi$-Prim-MST}\nobreak\ {\footnotesize {45b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb46a}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {46a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb46a}{46a}\NWlink{nuweb46b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}\NWlink{nuweb47}{, 47}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb46b}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {46b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb46a}{46a}\NWlink{nuweb46b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb28}{28}\NWlink{nuweb38b}{, 38b}\NWlink{nuweb47}{, 47}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb47}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {47}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb47}{47}\NWlink{nuweb48}{, 48}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@plotTour@\nobreak\ \NWlink{nuweb21c}{21c}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb46a}{46a}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb46b}{46b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb48}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {48}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb49a}{} $\langle\,${\itshape Animation routines for classic horsefly}\nobreak\ {\footnotesize {49a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb49b}{} $\langle\,${\itshape Set up configurations and parameters for animation and plotting}\nobreak\ {\footnotesize {49b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb50}{} $\langle\,${\itshape Parse input-output file and set up required data-structures}\nobreak\ {\footnotesize {50}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb51a}{} $\langle\,${\itshape Construct and store every frame of the animation in \verb|ims|}\nobreak\ {\footnotesize {51a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ims = []@\\
...
\NWtarget{nuweb51b}{} $\langle\,${\itshape Render frame and append it to \verb|ims|}\nobreak\ {\footnotesize {51b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb53a}{} $\langle\,${\itshape Define function to place points along a leg}\nobreak\ {\footnotesize {53a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb53b}{} $\langle\,${\itshape Write animation of schedule to disk and display in live window}\nobreak\ {\footnotesize {53b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb32a}{, 32a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Construct and store every frame of the animation in \verb|ims|\nobreak\ {\footnotesize \NWlink{nuweb51a}{51a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb49a}{49a}.}
\item $\langle\,$Define auxiliary helper functions\nobreak\ {\footnotesize \NWlink{nuweb38c}{38c}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
\item $\langle\,$Define function to place points along a leg\nobreak\ {\footnotesize \NWlink{nuweb53a}{53a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb51a}{51a}.}
...
\item $\langle\,$Define various insertion policy classes\nobreak\ {\footnotesize \NWlink{nuweb40a}{40a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
\item $\langle\,$Draw horse and fly-tours\nobreak\ {\footnotesize \NWlink{nuweb36a}{36a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
\item $\langle\,$Draw unvisited sites as filled blue circles\nobreak\ {\footnotesize \NWlink{nuweb36c}{36c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
\item $\langle\,$Extract $x$ and $y$ coordinates of the points on the horse, fly tours, visited and unvisited sites\nobreak\ {\footnotesize \NWlink{nuweb35a}{35a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
...
\item $\langle\,$For each node in current $\varphi$-Prim-MST compute the closest unmarked site\nobreak\ {\footnotesize \NWlink{nuweb44c}{44c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb44a}{44a}.}
...
\item $\langle\,$Get the node $M^{*}$ with the closest unmarked site $S^{*}$ from the previous step\nobreak\ {\footnotesize \NWlink{nuweb44d}{44d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb44a}{44a}.}
\item $\langle\,$Give metainformation about current picture as headers and footers\nobreak\ {\footnotesize \NWlink{nuweb36d}{36d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
...
\item $\langle\,$Local data-structures for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb24c}{24c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb46a}{46a}\NWlink{nuweb46b}{b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$Lower bounds for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb44a}{44a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$Make an animation of algorithm states, if \verb|write_algo_states_to_disk_p == True|\nobreak\ {\footnotesize \NWlink{nuweb37b}{37b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
\item $\langle\,$Make an animation of the schedule, if \verb|animate_schedule_p == True|\nobreak\ {\footnotesize \NWlink{nuweb38a}{38a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
\item $\langle\,$Mark initial position of horse and fly boldly on canvas\nobreak\ {\footnotesize \NWlink{nuweb35b}{35b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
\item $\langle\,$Mark site $S$, add node $R$ and edge $MR$ to the existing $\varphi$-Prim-MST\nobreak\ {\footnotesize \NWlink{nuweb45b}{45b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb44a}{44a}.}
...
\item $\langle\,$Place numbered markers on visited sites to mark the order of visitation explicitly\nobreak\ {\footnotesize \NWlink{nuweb36b}{36b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb47}{47}\NWlink{nuweb48}{, 48}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Return horsefly tour, along with additional information\nobreak\ {\footnotesize \NWlink{nuweb38b}{38b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
...
\item $\langle\,$Set up plotting area and canvas, fig, ax, and other configs\nobreak\ {\footnotesize \NWlink{nuweb34c}{34c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
...
\item $\langle\,$Start entering input from the command-line\nobreak\ {\footnotesize \NWlink{nuweb21c}{21c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21b}{21b}.}
\item $\langle\,$Update states for \texttt{PolicyBestInsertionNaive}\nobreak\ {\footnotesize \NWlink{nuweb42}{42}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb40b}{40b}.}
...
\item $\langle\,$Write algorithm's current state to file\nobreak\ {\footnotesize \NWlink{nuweb34a}{34a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
\item $\langle\,$Write animation of schedule to disk and display in live window\nobreak\ {\footnotesize \NWlink{nuweb53b}{53b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb49a}{49a}.}
\item $\langle\,$Write image file\nobreak\ {\footnotesize \NWlink{nuweb36e}{36e}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
\item $\langle\,$Write input and output to file\nobreak\ {\footnotesize \NWlink{nuweb37a}{37a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
\end{list}}
\section{Chapter Index of Identifiers}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb21c}{21c}\NWlink{nuweb26}{, 26}\NWlink{nuweb27}{, 27}, \underline{\NWlink{nuweb28}{28}}.
\item \verb@algo_greedy_incremental_insertion,@: \NWlink{nuweb21c}{21c}, \underline{\NWlink{nuweb32a}{32a}}.
\item \verb@compute_collinear_horseflies_tour@: \underline{\NWlink{nuweb39b}{39b}}\NWlink{nuweb42}{, 42}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb39a}{39a}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41c}{c}.
\item \verb@current_tour_length@: \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb41c}{, 41c}.
\item \verb@delta_increase_least@: \underline{\NWlink{nuweb41b}{41b}}\NWlink{nuweb41c}{, 41c}.
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb40b}{40b}}\NWlink{nuweb41c}{, 41c}\NWlink{nuweb41d}{d}.
\item \verb@HorseFlyInput@: \NWlink{nuweb24b}{24b}, \underline{\NWlink{nuweb24c}{24c}}.
\item \verb@ibest,@: \underline{\NWlink{nuweb41b}{41b}}\NWlink{nuweb41c}{, 41c}.
\item \verb@io_file_name,@: \underline{\NWlink{nuweb32b}{32b}}\NWlink{nuweb37a}{, 37a}.
\item \verb@logger@: \NWlink{nuweb21a}{21a}, \underline{\NWlink{nuweb32b}{32b}}.
\item \verb@number_of_sites_serviced@: \underline{\NWlink{nuweb51a}{51a}}\NWlink{nuweb51b}{, 51b}.
\item \verb@plotTour@: \NWlink{nuweb21c}{21c}, \underline{\NWlink{nuweb47}{47}}.
\item \verb@self.horse_tour@: \underline{\NWlink{nuweb40a}{40a}}\NWlink{nuweb42}{, 42}.
\item \verb@self.inithorseposn,@: \NWlink{nuweb24c}{24c}, \underline{\NWlink{nuweb40a}{40a}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41c}{c}\NWlink{nuweb42}{, 42}.
\item \verb@self.sites,@: \NWlink{nuweb24c}{24c}, \underline{\NWlink{nuweb40a}{40a}}.
\item \verb@self.visited_sites,@: \underline{\NWlink{nuweb40a}{40a}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb42}{, 42}.
\item \verb@single_site_solution@: \underline{\NWlink{nuweb38c}{38c}}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}.
\item \verb@tour_length@: \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}, \underline{\NWlink{nuweb46a}{46a}}\NWlink{nuweb47}{, 47}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb28}{28}\NWlink{nuweb38b}{, 38b}, \underline{\NWlink{nuweb46b}{46b}}\NWlink{nuweb47}{, 47}.
\item \verb@unmarked_sites_idxs@: \underline{\NWlink{nuweb44a}{44a}}.
\item \verb@wrapperkeyPressHandler@: \underline{\NWlink{nuweb21b}{21b}}\NWlink{nuweb24b}{, 24b}.
\item \verb@write_algo_states_to_disk_p@: \underline{\NWlink{nuweb32a}{32a}}\NWlink{nuweb34a}{, 34a}\NWlink{nuweb34b}{b}\NWlink{nuweb37b}{, 37b}.
\end{list}} 
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@"../main.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb11a}{11a}.}
\item \verb@"../src/lib/problem_classic_horsefly.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb20a}{20a}.}
\item \verb@"../src/lib/utils_algo.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb16a}{16a}\NWlink{nuweb16b}{b}\NWlink{nuweb17a}{, 17a}\NWlink{nuweb17b}{b}\NWlink{nuweb18}{, 18}.
}
\item \verb@"../src/lib/utils_graphics.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb13}{13}\NWlink{nuweb14a}{, 14a}\NWlink{nuweb14b}{b}\NWlink{nuweb15}{, 15}.
}
\end{list}}
