...
\mbox{}\verb@@\\
\mbox{}\verb@      for horse_leg, fly_leg, leg_idx in \@\\
\mbox{}\verb@               zip(horse_legs, fly_legs, range(len(horse_legs))):@\\
...
\NWtarget{nuweb48b}{} $\langle\,${\itshape Render frame and add to animation registry}\nobreak\ {\footnotesize {48b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@pass@\\
\mbox{}\verb@@{\NWsep}
