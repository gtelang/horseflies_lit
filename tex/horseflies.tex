...
\NWtarget{nuweb35}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {35}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\vspace{4ex}
\end{flushleft}
\UNSURE{\texttt{self.horse\_tour[0:]} or 
        \texttt{self.horse\_tour[1:]}}
...
\NWtarget{nuweb36a}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {36a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb36a}{36a}\NWlink{nuweb36b}{b}\NWlink{nuweb37a}{, 37a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb31}{31}.
...
\NWtarget{nuweb36b}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {36b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Define various insertion policy classes}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb38}{} $\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize {38}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb39c}{39c}\NWlink{nuweb40a}{, 40a}, \verb@insert_another_unvisited_site,@\nobreak\ \NWtxtIdentsNotUsed.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb39a}{} $\langle\,${\itshape Compute the length of the tour that currently services the visited sites}\nobreak\ {\footnotesize {39a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb38}{38}.
\item \NWtxtIdentsDefed\nobreak\  \verb@current_tour_length@\nobreak\ \NWlink{nuweb39c}{39c}.\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb36b}{36b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb39b}{} $\langle\,${\itshape Set up tracking variables local to this iteration}\nobreak\ {\footnotesize {39b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@ibest                = 0@\\
...
\NWtarget{nuweb39c}{} $\langle\,${\itshape If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}}\nobreak\ {\footnotesize {39c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb38}{38}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb36b}{36b}, \verb@current_tour_length@\nobreak\ \NWlink{nuweb39a}{39a}, \verb@delta_increase_least@\nobreak\ \NWlink{nuweb39b}{39b}, \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb38}{38}, \verb@ibest,@\nobreak\ \NWlink{nuweb39b}{39b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb40a}{} $\langle\,${\itshape Find the unvisited site which on insertion increases tour-length by the least amount}\nobreak\ {\footnotesize {40a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb40b}{} $\langle\,${\itshape Update states for \texttt{PolicyNaive}}\nobreak\ {\footnotesize {40b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb40c}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {40c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb40c}{40c}\NWlink{nuweb42a}{, 42a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}\NWlink{nuweb42b}{, 42b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb42a}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {42a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb40c}{40c}\NWlink{nuweb42a}{, 42a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb28}{28}\NWlink{nuweb35}{, 35}\NWlink{nuweb42b}{, 42b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb42b}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {42b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\item $\langle\,$Compute the length of the tour that currently services the visited sites\nobreak\ {\footnotesize \NWlink{nuweb39a}{39a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
\item $\langle\,$Define auxiliary helper functions\nobreak\ {\footnotesize \NWlink{nuweb36a}{36a}\NWlink{nuweb36b}{b}\NWlink{nuweb37a}{, 37a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb31}{31}.}
...
\item $\langle\,$Define various insertion policy classes\nobreak\ {\footnotesize \NWlink{nuweb37b}{37b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb31}{31}.}
\item $\langle\,$Find the unvisited site which on insertion increases tour-length by the least amount\nobreak\ {\footnotesize \NWlink{nuweb40a}{40a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb40c}{40c}\NWlink{nuweb42a}{, 42a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$Methods for \verb|PolicyNaive|\nobreak\ {\footnotesize \NWlink{nuweb38}{38}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb37b}{37b}.}
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb42b}{42b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Return horsefly tour, along with additional information\nobreak\ {\footnotesize \NWlink{nuweb35}{35}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb31}{31}.}
...
\item $\langle\,$Set up tracking variables local to this iteration\nobreak\ {\footnotesize \NWlink{nuweb39b}{39b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
...
\item $\langle\,$Update states for \texttt{PolicyNaive}\nobreak\ {\footnotesize \NWlink{nuweb40b}{40b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
...
\item \verb@algo_state_counter@: \underline{\NWlink{nuweb32a}{32a}}\NWlink{nuweb33b}{, 33b}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb36b}{36b}}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39c}{c}.
\item \verb@current_tour_length@: \underline{\NWlink{nuweb39a}{39a}}\NWlink{nuweb39c}{, 39c}.
\item \verb@delta_increase_least@: \underline{\NWlink{nuweb39b}{39b}}\NWlink{nuweb39c}{, 39c}.
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb38}{38}}\NWlink{nuweb39c}{, 39c}\NWlink{nuweb40a}{, 40a}.
\item \verb@HorseFlyInput@: \NWlink{nuweb23b}{23b}, \underline{\NWlink{nuweb24}{24}}.
\item \verb@ibest,@: \underline{\NWlink{nuweb39b}{39b}}\NWlink{nuweb39c}{, 39c}.
\item \verb@plotTour@: \NWlink{nuweb21b}{21b}, \underline{\NWlink{nuweb42b}{42b}}.
\item \verb@run_handler@: \underline{\NWlink{nuweb20a}{20a}}.
\item \verb@tour_length@: \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}, \underline{\NWlink{nuweb40c}{40c}}\NWlink{nuweb42b}{, 42b}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb28}{28}\NWlink{nuweb35}{, 35}, \underline{\NWlink{nuweb42a}{42a}}\NWlink{nuweb42b}{, 42b}.
