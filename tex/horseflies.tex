...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb17a}{17a}\NWlink{nuweb17b}{b}\NWlink{nuweb18a}{, 18a}\NWlink{nuweb18b}{b}\NWlink{nuweb18c}{c}\NWlink{nuweb18d}{d}\NWlink{nuweb19a}{, 19a}\NWlink{nuweb19b}{b}.
...
\NWtarget{nuweb76b}{} $\langle\,${\itshape Helper functions for \verb|algo_greedy_earliest_capture|}\nobreak\ {\footnotesize {76b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb76c}{} $\langle\,${\itshape Definition of the \verb|FlyState| class}\nobreak\ {\footnotesize {76c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@         self._flytraj                           = [ np.asarray(initflyposn) ]@\\
...
\mbox{}\verb@ @\\
\mbox{}\verb@    def redeploy_to_site(self,site):@\\
\mbox{}\verb@         self._current_assigned_site            = np.asarray(site)@\\
\mbox{}\verb@         self._current_assigned_site_serviced_p = False @\\
\mbox{}\verb@@\\
...
\mbox{}\verb@         return self._flytraj[-1]@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@    @\hbox{$\langle\,${\itshape Definition of method \verb|print_current_state|}\nobreak\ {\footnotesize \NWlink{nuweb78a}{78a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb77}{} $\langle\,${\itshape Definition of method \verb|rendezvous_time_and_point_if_selected_by_horse|}\nobreak\ {\footnotesize {77}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@       rt = meeting_time_horse_fly_opp_dir(horseposn, \@\\
\mbox{}\verb@                                           self.get_current_fly_position(),\@\\
\mbox{}\verb@                                           self._speed)@\\
\mbox{}\verb@       horseheading = self.get_current_fly_position()@\\
\mbox{}\verb@   else:@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@      horse_site_vec   = np.linalg.norm(self._current_assigned_site - horseposn) @\\
\mbox{}\verb@      displacement_vec = time_of_fly_to_site * horse_site_vec/np.linalg.norm(horse_site_vec)@\\
\mbox{}\verb@      horse_posn_tmp   = horse_posn + displacement_vec@\\
\mbox{}\verb@@\\
\mbox{}\verb@      time_of_fly_from_site = meeting_time_horse_fly_opp_dir(  \@\\
\mbox{}\verb@                                  horseposn_tmp,               \@\\
\mbox{}\verb@                                  self._current_assigned_site, \@\\
\mbox{}\verb@                                  self._speed)@\\
\mbox{}\verb@@\\
\mbox{}\verb@      rt = time_of_fly_to_site + time_of_fly_from_site@\\
\mbox{}\verb@      horseheading = self._current_assigned_site@\\
\mbox{}\verb@@\\
\mbox{}\verb@   uhorseheading = horseheading/np.linalg.norm(uhorseheading)@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb76c}{76c}.
\item \NWtxtIdentsDefed\nobreak\  \verb@rendezvous_time_and_point_if_selected_by_horse@\nobreak\ \NWlink{nuweb79a}{79a}.\item \NWtxtIdentsUsed\nobreak\  \verb@meeting_time_horse_fly_opp_dir@\nobreak\ \NWlink{nuweb76b}{76b}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb78a}{} $\langle\,${\itshape Definition of method \verb|print_current_state|}\nobreak\ {\footnotesize {78a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@def print_current_state(self):@\\
\mbox{}\verb@    fly_speed_str = "Fly Speed is " + str(self._speed)                             @\\
\mbox{}\verb@    fly_traj_str  = "Fly trajectory is " + ''.join(map(str, self._flytraj))             @\\
\mbox{}\verb@    current_assigned_site_str = "Current assigned site is " +\@\\
\mbox{}\verb@                                 str(self._current_assigned_site)             @\\
\mbox{}\verb@    current_assigned_site_serviced_p_str = "Assigned site serviced: " +\@\\
\mbox{}\verb@                                            str(self._current_assigned_site_serviced_p) @\\
\mbox{}\verb@    fly_retired_p_str = "Fly retired: " +  str(self._fly_retired_p)@\\
\mbox{}\verb@    @\\
\mbox{}\verb@    print '...................................................................'@\\
\mbox{}\verb@    print Fore.BLUE    , fly_speed_str             , Style.RESET_ALL@\\
\mbox{}\verb@    print Fore.MAGENTA , fly_traj_str              , Style.RESET_ALL@\\
\mbox{}\verb@    print Fore.YELLOW  , current_assigned_site_str , Style.RESET_ALL@\\
\mbox{}\verb@    print Fore.GREEN   , current_assigned_site_serviced_p_str, Style.RESET_ALL@\\
\mbox{}\verb@    print Fore.RED     , fly_retired_p_str         , Style.RESET_ALL@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb78b}{} $\langle\,${\itshape Find the $k$-nearest sites to \verb|inithorseposn| for $k=$\verb|number_of_flies| and claim them}\nobreak\ {\footnotesize {78b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@from sklearn.neighbors import NearestNeighbors@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb78c}{} $\langle\,${\itshape Initialize one \verb|FlyState| object per fly for all flies}\nobreak\ {\footnotesize {78c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@flystates = []@\\
\mbox{}\verb@for i in range(number_of_flies):@\\
\mbox{}\verb@    flystates.append(FlyState(inithorseposn, knns[i], phi))@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb79a}{} $\langle\,${\itshape Find the index of the fly \bm{F} which can meet the horse at the earliest, the rendezvous point $R$, and time till rendezvous}\nobreak\ {\footnotesize {79a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@imin  = 0@\\
...
\mbox{}\verb@@\\
\mbox{}\verb@     if self._current_assigned_site_serviced_p or \@\\
\mbox{}\verb@                 (dx < np.linalg.norm( self._current_assigned_site -\@\\
\mbox{}\verb@                                       self.get_current_fly_position())):   @\\
\mbox{}\verb@@\\
\mbox{}\verb@          heading  = self.fly_traj[-1] - self.fly_traj[-2]@\\
\mbox{}\verb@          uheading = heading / np.linalg.norm(heading) @\\
\mbox{}\verb@          newpt = self.fly_traj[-1] + dx * uheading@\\
\mbox{}\verb@          self.fly_traj.append(newpt)@\\
\mbox{}\verb@@\\
\mbox{}\verb@     else: # the fly needs to ``uturn'' at the site@\\
\mbox{}\verb@          dx_reduced = dx - np.linalg.norm(self._current_assigned_site -\@\\
\mbox{}\verb@                                           self.get_current_fly_position())@\\
\mbox{}\verb@          assert(dx_reduced >= 0, "dx_reduced should be >= 0")@\\
...
\mbox{}\verb@          self.fly_traj.extend([self._current_assigned_site, newpt])@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb79d}{} $\langle\,${\itshape Update \verb|current_horse_posn| and horse trajectory}\nobreak\ {\footnotesize {79d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb80a}{} $\langle\,${\itshape Deploy \bm{F} to an unclaimed site if one exists and claim that site, otherwise retire \bm{F}}\nobreak\ {\footnotesize {80a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\mbox{}\verb@@\\
\mbox{}\verb@    assert( np.linalg.norm ( sites[unclaimed_sites_idxs[nn_idx]]  - \@\\
\mbox{}\verb@                             unclaimed_sites[nn_idx]  ) < 1e-8, \@\\
\mbox{}\verb@            "Assertion failure in deployment step" )@\\
\mbox{}\verb@@\\
\mbox{}\verb@    flystates[imin].redeploy_to_site(unclaimed_sites[nn_idx])@\\
\mbox{}\verb@    unclaimed_sites_idxs = list(set(unclaimed_sites_idxs) - \@\\
\mbox{}\verb@                                set([unclaimed_sites_idxs[nn_idx]]))@\\
\mbox{}\verb@@\\
\mbox{}\verb@else: # All sites have been claimed by some drone. There is no need for the fly anymore@\\
...
\NWtarget{nuweb80b}{} $\langle\,${\itshape Calculate value of \verb|all_flies_retired_p|}\nobreak\ {\footnotesize {80b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@acc = True # accumulator variabvle@\\
\mbox{}\verb@for i in range(number_of_flies):@\\
\mbox{}\verb@     acc and flystates[i].is_retired()@\\
\mbox{}\verb@all_flies_retired_p = tmp@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\item $\langle\,$Definition of method \verb|print_current_state|\nobreak\ {\footnotesize \NWlink{nuweb78a}{78a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76c}{76c}.}
\item $\langle\,$Definition of method \verb|rendezvous_time_and_point_if_selected_by_horse|\nobreak\ {\footnotesize \NWlink{nuweb77}{77}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76c}{76c}.}
\item $\langle\,$Definition of method \verb|update_fly_trajectory|\nobreak\ {\footnotesize \NWlink{nuweb79c}{79c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76c}{76c}.}
\item $\langle\,$Definition of the \verb|FlyState| class\nobreak\ {\footnotesize \NWlink{nuweb76c}{76c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
\item $\langle\,$Deploy \bm{F} to an unclaimed site if one exists and claim that site, otherwise retire \bm{F}\nobreak\ {\footnotesize \NWlink{nuweb80a}{80a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
\item $\langle\,$Find the $k$-nearest sites to \verb|inithorseposn| for $k=$\verb|number_of_flies| and claim them\nobreak\ {\footnotesize \NWlink{nuweb78b}{78b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
...
\item $\langle\,$Initialize one \verb|FlyState| object per fly for all flies\nobreak\ {\footnotesize \NWlink{nuweb78c}{78c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
...
\item $\langle\,$Make an animation of the schedule if \verb|animate_schedule_p == True|\nobreak\ {\footnotesize ?}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
...
\item $\langle\,$Update \verb|current_horse_posn| and horse trajectory\nobreak\ {\footnotesize \NWlink{nuweb79d}{79d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
...
\item \verb@getTour@: \NWlink{nuweb72a}{72a}, \underline{\NWlink{nuweb74c}{74c}}.
\item \verb@meeting_time_horse_fly_opp_dir@: \underline{\NWlink{nuweb76b}{76b}}\NWlink{nuweb77}{, 77}.
\item \verb@rendezvous_time_and_point_if_selected_by_horse@: \underline{\NWlink{nuweb77}{77}}\NWlink{nuweb79a}{, 79a}.
...
\item \verb@"../src/lib/utils_algo.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb17a}{17a}\NWlink{nuweb17b}{b}\NWlink{nuweb18a}{, 18a}\NWlink{nuweb18b}{b}\NWlink{nuweb18c}{c}\NWlink{nuweb18d}{d}\NWlink{nuweb19a}{, 19a}\NWlink{nuweb19b}{b}.
}
