...
\newchunk Each of the files with prefix ``\verb|problem_*|'' contain implmentations of 
 ...
 output against good lower bounds. Hence each such file, will also collect routines
 for efficiently computing or approximating various lower-bounds for the corresponding
 problem's \textit{OPT}. 


 All such files are in the directory \texttt{src/lib/}

\newchunk Similarly, each of the files with prefix ``\verb|expt_*|'' contain code
 ...
 for each of the problems. Thus \verb|expt_watchman_horsefly.py| contains 
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb31}{31}\NWlink{nuweb32}{, 32}\NWlink{nuweb36}{, 36}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb24a}{24a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb32}{32}.
\item{}
\end{list}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb31}{31}\NWlink{nuweb32}{, 32}\NWlink{nuweb36}{, 36}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb24a}{24a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb31}{, 31}\NWlink{nuweb36}{, 36}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb37a}{37a}\NWlink{nuweb37b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb24a}{24a}.
...
\NWtarget{nuweb38}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {38}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb31}{31}\NWlink{nuweb32}{, 32}\NWlink{nuweb36}{, 36}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb24a}{24a}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb37a}{37a}\NWlink{nuweb37b}{b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb24a}{24a}.}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb26}{26}\NWlink{nuweb31}{, 31}, \underline{\NWlink{nuweb32}{32}}\NWlink{nuweb36}{, 36}.
\end{list}} 
