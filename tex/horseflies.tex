...
\NWtarget{nuweb21a}{} $\langle\,${\itshape Define key-press handler}\nobreak\ {\footnotesize {21a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb21b}{} $\langle\,${\itshape Start entering input from the command-line}\nobreak\ {\footnotesize {21b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb22}{} $\langle\,${\itshape Generate a bunch of uniform or non-uniform random points on the canvas}\nobreak\ {\footnotesize {22}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@numpts = int(sys.argv[2]) @\\
...
\NWtarget{nuweb23a}{} $\langle\,${\itshape Clear canvas and states of all objects}\nobreak\ {\footnotesize {23a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@run.clearAllStates()@\\
\mbox{}\verb@ax.cla()@\\
...
\NWtarget{nuweb23b}{} $\langle\,${\itshape Set up interactive canvas}\nobreak\ {\footnotesize {23b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@HorseFlyInput@\nobreak\ \NWlink{nuweb24}{24}, \verb@wrapperkeyPressHandler@\nobreak\ \NWlink{nuweb21a}{21a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb24}{} $\langle\,${\itshape Local data-structures for classic horsefly}\nobreak\ {\footnotesize {24}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb26}{26}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}\NWlink{nuweb32a}{, 32a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb21b}{21b}\NWlink{nuweb26}{, 26}\NWlink{nuweb27}{, 27}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb43}{43}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb44a}{44a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtIdentsDefed\nobreak\  \verb@io_file_name,@\nobreak\ \NWlink{nuweb37b}{37b}, \verb@logger@\nobreak\ \NWlink{nuweb33a}{33a}\NWlink{nuweb33b}{b}\NWlink{nuweb34a}{, 34a}\NWlink{nuweb37b}{, 37b}\NWlink{nuweb38a}{, 38a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb34b}{} $\langle\,${\itshape If \verb|animate_algo_p| flag is set to \verb|True|, render current algorithm state to file}\nobreak\ {\footnotesize {34b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import utils_algo@\\
...
\NWtarget{nuweb35a}{} $\langle\,${\itshape Set up plotting area and canvas, fig, ax, and other configs}\nobreak\ {\footnotesize {35a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb35b}{} $\langle\,${\itshape Extract $x$ and $y$ coordinates of the points on the horse, fly tours, visited and unvisited sites}\nobreak\ {\footnotesize {35b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\NWtarget{nuweb36a}{} $\langle\,${\itshape Mark initial position of horse and fly boldly on canvas}\nobreak\ {\footnotesize {36a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ax.add_patch( mpl.patches.Circle( inithorseposn, \@\\
...
\NWtarget{nuweb36b}{} $\langle\,${\itshape Draw horse and fly-tours}\nobreak\ {\footnotesize {36b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ax.plot(xfs,yfs,'g-',linewidth=1.5)  @\\
\mbox{}\verb@ax.plot(xhs, yhs, color='r', \@\\
\mbox{}\verb@        marker='s', markersize=3, \@\\
\mbox{}\verb@        linewidth=2.0) @\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb36c}{} $\langle\,${\itshape Place numbered markers on visited sites to mark the order of visitation explicitly}\nobreak\ {\footnotesize {36c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36d}{} $\langle\,${\itshape Draw unvisited sites as filled blue circles}\nobreak\ {\footnotesize {36d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36e}{} $\langle\,${\itshape Give metainformation about current picture as headers and footers}\nobreak\ {\footnotesize {36e}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
20 figures. I have linked to the stack overflow answer which advises to call 
\verb|plt.close('all')| after writing out a file. 

\begin{flushleft} \small\label{scrap35}\raggedright\small
\NWtarget{nuweb37a}{} $\langle\,${\itshape Write image file}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\mbox{}\verb@            bbox_inches='tight')@\\
\mbox{}\verb@print "Wrote " + image_file_name + " to disk"   @\\
\mbox{}\verb@plt.close('all') # https://stackoverflow.com/a/21884375/505306@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Write input and output to file}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@io_file_name,@\nobreak\ \NWlink{nuweb32b}{32b}, \verb@logger@\nobreak\ \NWlink{nuweb32b}{32b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37c}{} $\langle\,${\itshape If \verb|animate_algo_p| $==$ \verb|True|, make an animation of algorithm states}\nobreak\ {\footnotesize {37c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@if animate_algo_p:@\\
\mbox{}\verb@     import subprocess, os@\\
\mbox{}\verb@     os.chdir(dir_name)@\\
\mbox{}\verb@     subprocess.call( ['ffmpeg', '-r', '1',  '-i', 'algo_state_%05d.png', \@\\
\mbox{}\verb@                       '-vcodec', 'mpeg4', '-r', '10' ,'algo_state_animation.avi']  )@\\
\mbox{}\verb@     os.chdir('../')@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb38a}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {38a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@logger@\nobreak\ \NWlink{nuweb32b}{32b}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb44a}{44a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb38b}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {38b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb38b}{38b}\NWlink{nuweb38c}{c}\NWlink{nuweb39}{, 39}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb38c}{38c}\NWlink{nuweb39}{, 39}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb39}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {39}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32a}{32a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@self.horse_tour@\nobreak\ \NWlink{nuweb42b}{42b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb24}{24}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41c}{c}\NWlink{nuweb42b}{, 42b}, \verb@self.sites,@\nobreak\ \NWlink{nuweb24}{24}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb41a}{41a}\NWlink{nuweb42b}{, 42b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb40b}{} $\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize {40b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb41c}{41c}\NWlink{nuweb42a}{, 42a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb42a}{} $\langle\,${\itshape Find the unvisited site which on insertion increases tour-length by the least amount}\nobreak\ {\footnotesize {42a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb42b}{} $\langle\,${\itshape Update states for \texttt{PolicyNaive}}\nobreak\ {\footnotesize {42b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb43}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {43}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb43}{43}\NWlink{nuweb44a}{, 44a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}\NWlink{nuweb44b}{, 44b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb43}{43}\NWlink{nuweb44a}{, 44a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb28}{28}\NWlink{nuweb38a}{, 38a}\NWlink{nuweb44b}{, 44b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb44b}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {44b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@plotTour@\nobreak\ \NWlink{nuweb21b}{21b}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb43}{43}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb44a}{44a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item $\langle\,$Clear canvas and states of all objects\nobreak\ {\footnotesize \NWlink{nuweb23a}{23a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
...
\item $\langle\,$Define auxiliary helper functions\nobreak\ {\footnotesize \NWlink{nuweb38b}{38b}\NWlink{nuweb38c}{c}\NWlink{nuweb39}{, 39}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
...
\item $\langle\,$Generate a bunch of uniform or non-uniform random points on the canvas\nobreak\ {\footnotesize \NWlink{nuweb22}{22}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
...
\item $\langle\,$If \verb|animate_algo_p| $==$ \verb|True|, make an animation of algorithm states\nobreak\ {\footnotesize \NWlink{nuweb37c}{37c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32a}{32a}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb43}{43}\NWlink{nuweb44a}{, 44a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb44b}{44b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Set up interactive canvas\nobreak\ {\footnotesize \NWlink{nuweb23b}{23b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Write image file\nobreak\ {\footnotesize \NWlink{nuweb37a}{37a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb21b}{21b}\NWlink{nuweb26}{, 26}\NWlink{nuweb27}{, 27}, \underline{\NWlink{nuweb28}{28}}.
\item \verb@algo_greedy_incremental_insertion,@: \NWlink{nuweb21b}{21b}, \underline{\NWlink{nuweb32a}{32a}}.
\item \verb@animate_algo_p@: \underline{\NWlink{nuweb32a}{32a}}\NWlink{nuweb34b}{, 34b}\NWlink{nuweb37c}{, 37c}.
\item \verb@compute_collinear_horseflies_tour@: \underline{\NWlink{nuweb39}{39}}\NWlink{nuweb42b}{, 42b}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb38c}{38c}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41c}{c}.
...
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb40b}{40b}}\NWlink{nuweb41c}{, 41c}\NWlink{nuweb42a}{, 42a}.
\item \verb@HorseFlyInput@: \NWlink{nuweb23b}{23b}, \underline{\NWlink{nuweb24}{24}}.
\item \verb@ibest,@: \underline{\NWlink{nuweb41b}{41b}}\NWlink{nuweb41c}{, 41c}.
\item \verb@io_file_name,@: \underline{\NWlink{nuweb32b}{32b}}\NWlink{nuweb37b}{, 37b}.
\item \verb@logger@: \underline{\NWlink{nuweb32b}{32b}}\NWlink{nuweb33a}{, 33a}\NWlink{nuweb33b}{b}\NWlink{nuweb34a}{, 34a}\NWlink{nuweb37b}{, 37b}\NWlink{nuweb38a}{, 38a}.
\item \verb@plotTour@: \NWlink{nuweb21b}{21b}, \underline{\NWlink{nuweb44b}{44b}}.
\item \verb@run_handler@: \underline{\NWlink{nuweb20a}{20a}}.
\item \verb@self.horse_tour@: \underline{\NWlink{nuweb40a}{40a}}\NWlink{nuweb42b}{, 42b}.
\item \verb@self.inithorseposn,@: \NWlink{nuweb24}{24}, \underline{\NWlink{nuweb40a}{40a}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41c}{c}\NWlink{nuweb42b}{, 42b}.
\item \verb@self.sites,@: \NWlink{nuweb24}{24}, \underline{\NWlink{nuweb40a}{40a}}.
\item \verb@self.visited_sites,@: \underline{\NWlink{nuweb40a}{40a}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb42b}{, 42b}.
\item \verb@single_site_solution@: \underline{\NWlink{nuweb38b}{38b}}\NWlink{nuweb38c}{, 38c}\NWlink{nuweb39}{, 39}.
\item \verb@tour_length@: \NWlink{nuweb26}{26}\NWlink{nuweb28}{, 28}, \underline{\NWlink{nuweb43}{43}}\NWlink{nuweb44b}{, 44b}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb28}{28}\NWlink{nuweb38a}{, 38a}, \underline{\NWlink{nuweb44a}{44a}}\NWlink{nuweb44b}{, 44b}.
\item \verb@wrapperkeyPressHandler@: \underline{\NWlink{nuweb21a}{21a}}\NWlink{nuweb23b}{, 23b}.
\end{list}} 
