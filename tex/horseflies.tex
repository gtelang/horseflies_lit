...
\item \crunchy{Tests} All such files are in the directory \texttt{src/test/}
 ...
 Every problem, utility, and experimental files in \verb|src/lib| and \verb|src/expts | has 
 a corresponding test-file in this folder. 
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb16}{16}\NWlink{nuweb17}{, 17}\NWlink{nuweb18a}{, 18a}\NWlink{nuweb18b}{b}.
...
\NWtarget{nuweb17}{} \verb@"../src/lib/utils_graphics.py"@\nobreak\ {\footnotesize {17}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb18a}{} \verb@"../src/lib/utils_graphics.py"@\nobreak\ {\footnotesize {18a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb18b}{} \verb@"../src/lib/utils_graphics.py"@\nobreak\ {\footnotesize {18b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb20}{} \verb@"../src/lib/utils_algo.py"@\nobreak\ {\footnotesize {20}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import numpy as np@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb20}{20}\NWlink{nuweb21a}{, 21a}\NWlink{nuweb21b}{b}\NWlink{nuweb22a}{, 22a}\NWlink{nuweb22b}{b}.
...
\NWtarget{nuweb22a}{} \verb@"../src/lib/utils_algo.py"@\nobreak\ {\footnotesize {22a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb22b}{} \verb@"../src/lib/utils_algo.py"@\nobreak\ {\footnotesize {22b}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb25a}{} \verb@"../src/lib/problem_classic_horsefly.py"@\nobreak\ {\footnotesize {25a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\NWtarget{nuweb25b}{} $\langle\,${\itshape Relevant imports for classic horsefly}\nobreak\ {\footnotesize {25b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb26}{} $\langle\,${\itshape Define key-press handler}\nobreak\ {\footnotesize {26}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb27}{} $\langle\,${\itshape Start entering input from the command-line}\nobreak\ {\footnotesize {27}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb28}{} $\langle\,${\itshape Generate a bunch of uniform or non-uniform random points on the canvas}\nobreak\ {\footnotesize {28}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb29a}{} $\langle\,${\itshape Clear canvas and states of all objects}\nobreak\ {\footnotesize {29a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@run.clearAllStates()@\\
\mbox{}\verb@ax.cla()@\\
...
\NWtarget{nuweb29b}{} $\langle\,${\itshape Set up interactive canvas}\nobreak\ {\footnotesize {29b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb30}{} $\langle\,${\itshape Local data-structures for classic horsefly}\nobreak\ {\footnotesize {30}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb32}{32}\NWlink{nuweb33}{, 33}\NWlink{nuweb34}{, 34}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb25a}{25a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb34}{34}.
\item{}
\end{list}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb32}{32}\NWlink{nuweb33}{, 33}\NWlink{nuweb34}{, 34}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb25a}{25a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb27}{27}\NWlink{nuweb32}{, 32}\NWlink{nuweb33}{, 33}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {37}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb37}{37}\NWlink{nuweb38a}{, 38a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb25a}{25a}.
...
\NWtarget{nuweb38a}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {38a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb38b}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {38b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\item \verb@"../src/lib/problem_classic_horsefly.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb25a}{25a}.}
\item \verb@"../src/lib/utils_algo.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb20}{20}\NWlink{nuweb21a}{, 21a}\NWlink{nuweb21b}{b}\NWlink{nuweb22a}{, 22a}\NWlink{nuweb22b}{b}.
}
\item \verb@"../src/lib/utils_graphics.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb16}{16}\NWlink{nuweb17}{, 17}\NWlink{nuweb18a}{, 18a}\NWlink{nuweb18b}{b}.
}
\end{list}}
\chapter{Index of Fragments}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb32}{32}\NWlink{nuweb33}{, 33}\NWlink{nuweb34}{, 34}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb25a}{25a}.}
\item $\langle\,$Clear canvas and states of all objects\nobreak\ {\footnotesize \NWlink{nuweb29a}{29a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\item $\langle\,$Define key-press handler\nobreak\ {\footnotesize \NWlink{nuweb26}{26}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb25a}{25a}.}
\item $\langle\,$Generate a bunch of uniform or non-uniform random points on the canvas\nobreak\ {\footnotesize \NWlink{nuweb28}{28}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\item $\langle\,$Local data-structures for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb30}{30}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb25a}{25a}.}
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb37}{37}\NWlink{nuweb38a}{, 38a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb25a}{25a}.}
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb38b}{38b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb25a}{25a}.}
...
\item $\langle\,$Set up interactive canvas\nobreak\ {\footnotesize \NWlink{nuweb29b}{29b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb25a}{25a}.}
\item $\langle\,$Start entering input from the command-line\nobreak\ {\footnotesize \NWlink{nuweb27}{27}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb26}{26}.}
\end{list}}
\chapter{Index of Identifiers}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb27}{27}\NWlink{nuweb32}{, 32}\NWlink{nuweb33}{, 33}, \underline{\NWlink{nuweb34}{34}}.
\end{list}} 
