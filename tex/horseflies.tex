...
\NWtarget{nuweb13a}{} \verb@"../main.py"@\nobreak\ {\footnotesize {13a}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb13b}{} $\langle\,${\itshape Turn off Matplotlibs irritating DEBUG messages}\nobreak\ {\footnotesize {13b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb13c}{} $\langle\,${\itshape Import problem module files}\nobreak\ {\footnotesize {13c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb27}{27}\NWlink{nuweb28}{, 28}\NWlink{nuweb31a}{, 31a}\NWlink{nuweb32b}{, 32b}\NWlink{nuweb38a}{, 38a}\NWlink{nuweb52}{, 52}\NWlink{nuweb55}{, 55}\NWlink{nuweb57}{, 57}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_greedy_incremental_insertion,@\nobreak\ \NWlink{nuweb22}{22}, \verb@write_algo_states_to_disk_p@\nobreak\ \NWlink{nuweb28}{28}\NWlink{nuweb40a}{, 40a}\NWlink{nuweb40c}{c}\NWlink{nuweb43c}{, 43c}\NWlink{nuweb68}{, 68}\NWlink{nuweb69}{, 69}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb58a}{58a}\NWlink{nuweb58b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb31a}{31a}\NWlink{nuweb32b}{, 32b}\NWlink{nuweb44b}{, 44b}\NWlink{nuweb61a}{, 61a}\NWlink{nuweb68}{, 68}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@plotTour@\nobreak\ \NWlink{nuweb22}{22}\NWlink{nuweb69}{, 69}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\mbox{}\verb@    ax.text(x, y, str(i+1), fontsize=14, bbox=dict(facecolor='#ddcba0', alpha=1.0)) @\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb68}{} \verb@"../src/expts/expt_collinear_snap_length_increase.py"@\nobreak\ {\footnotesize {68}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\mbox{}\verb@import matplotlib as mpl@\\
\mbox{}\verb@@\\
\mbox{}\verb@def expt(number_of_sites, scheme, inithorseposn, phis, number_of_runs):@\\
\mbox{}\verb@  plt.rc('text', usetex=True)@\\
\mbox{}\verb@  plt.rc('font', family='serif')@\\
\mbox{}\verb@  fig, ax = plt.subplots()@\\
\mbox{}\verb@  ax.set_title("Tour Length of Collinear Horsefly Tour/Tour Length of Exact Horsefly Tour \n for Greedy Incremental Ordering, $N$="+str(number_of_sites), fontsize=28)@\\
\mbox{}\verb@  ax.set_xlabel("Runs", fontsize=25)@\\
\mbox{}\verb@  ax.set_ylabel("Tour Length Ratios", fontsize=25)@\\
\mbox{}\verb@  #plt.grid(True, linestyle='--')@\\
\mbox{}\verb@  plt.tick_params(labelsize=20)@\\
\mbox{}\verb@  #ax.set_xticklabels(map(str,range(number_of_runs)))@\\
\mbox{}\verb@  #ax.minorticks_on()@\\
\mbox{}\verb@@\\
\mbox{}\verb@  ax.set_ylim([0.75,1.75])@\\
\mbox{}\verb@  @\\
\mbox{}\verb@  for phi in phis:@\\
\mbox{}\verb@     ratios = []@\\
\mbox{}\verb@     for i in range(number_of_runs):@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@           sys.exit()                              @\\
\mbox{}\verb@      @\\
\mbox{}\verb@         collinear_tour             = chf.algo_greedy_incremental_insertion(sites, inithorseposn, phi,\@\\
\mbox{}\verb@                                                write_algo_states_to_disk_p = False,@\\
\mbox{}\verb@                                                animate_schedule_p          = False,@\\
\mbox{}\verb@                                                post_optimizer=None)@\\
\mbox{}\verb@      @\\
\mbox{}\verb@         collinear_tour_after_slsqp = chf.algo_greedy_incremental_insertion(sites, inithorseposn, phi,\@\\
\mbox{}\verb@                                                write_algo_states_to_disk_p = False,@\\
\mbox{}\verb@                                                animate_schedule_p          = False,@\\
\mbox{}\verb@                                                post_optimizer=chf.algo_exact_given_specific_ordering)@\\
\mbox{}\verb@@\\
\mbox{}\verb@         ratios.append(collinear_tour['tour_length_with_waiting_time_included']/@\\
\mbox{}\verb@                    collinear_tour_after_slsqp['tour_length_with_waiting_time_included'])@\\
\mbox{}\verb@      @\\
\mbox{}\verb@         print "..........................................................................................................."@\\
\mbox{}\verb@         print "Collinear Tour Length            : ", collinear_tour['tour_length_with_waiting_time_included']@\\
\mbox{}\verb@         print "Collinear Tour Length After SLSQP: ", collinear_tour_after_slsqp['tour_length_with_waiting_time_included']@\\
\mbox{}\verb@@\\
\mbox{}\verb@     plt.plot(range(number_of_runs), ratios, "o-", label=r"$\varphi$="+str(phi))@\\
\mbox{}\verb@     @\\
\mbox{}\verb@  ax.legend(prop={'size': 20})@\\
\mbox{}\verb@  plt.show()@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@if __name__ == "__main__":@\\
\mbox{}\verb@    expt(number_of_sites=10, scheme='uniform', inithorseposn=(0.5,0.5), \@\\
\mbox{}\verb@         phis=[3.0, 6.0, 12.0, 24.0], number_of_runs=40)@\\
\mbox{}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb31a}{31a}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb58b}{58b}, \verb@write_algo_states_to_disk_p@\nobreak\ \NWlink{nuweb38a}{38a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
%{/python-mode}%
\section{\framebox{Experiment} : An interesting example for Greedy Incremental Insertion}  



%{python-mode}%
\begin{flushleft} \small\label{scrap102}\raggedright\small
\NWtarget{nuweb69}{} \verb@"../src/expts/expt_interesting_example_gincex.py"@\nobreak\ {\footnotesize {69}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import sys, os                                                                                   @\\
...
\mbox{}\verb@import matplotlib as mpl@\\
\mbox{}\verb@@\\
\mbox{}\verb@xs  = np.linspace(0.20, 0.9, 13)@\\
\mbox{}\verb@y1s = np.empty(len(xs)); y1s.fill(0.6)@\\
\mbox{}\verb@y2s = np.empty(len(xs)); y2s.fill(0.4)@\\
\mbox{}\verb@sites = zip(xs,y1s) + zip(xs,y2s)@\\
\mbox{}\verb@inithorseposn = (0.1,0.5)@\\
\mbox{}\verb@phi=20.0@\\
\mbox{}\verb@@\\
\mbox{}\verb@utils_algo.print_list(sites)@\\
\mbox{}\verb@                                                                                         @\\
\mbox{}\verb@collinear_tour  = chf.algo_greedy_incremental_insertion(sites, inithorseposn, phi,@\\
\mbox{}\verb@                                    write_algo_states_to_disk_p = True,             @\\
\mbox{}\verb@                                    animate_schedule_p          = False,             @\\
\mbox{}\verb@                                    post_optimizer=chf.algo_exact_given_specific_ordering)  @\\
\mbox{}\verb@chf.plotTour(collinear_tour, inithorseposn, phi, 'gincoll')@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@tsp_ordering_tour = chf.algo_tsp_ordering(sites, inithorseposn, phi,@\\
\mbox{}\verb@                                    post_optimizer=chf.algo_exact_given_specific_ordering)  @\\
\mbox{}\verb@chf.plotTour(tsp_ordering_tour, inithorseposn, phi, 'tsp')@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb31a}{31a}, \verb@plotTour@\nobreak\ \NWlink{nuweb59}{59}, \verb@write_algo_states_to_disk_p@\nobreak\ \NWlink{nuweb38a}{38a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb22}{22}\NWlink{nuweb27}{, 27}\NWlink{nuweb29b}{, 29b}, \underline{\NWlink{nuweb31a}{31a}}\NWlink{nuweb68}{, 68}\NWlink{nuweb69}{, 69}.
...
\item \verb@plotTour@: \NWlink{nuweb22}{22}, \underline{\NWlink{nuweb59}{59}}\NWlink{nuweb69}{, 69}.
...
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb31a}{31a}\NWlink{nuweb32b}{, 32b}\NWlink{nuweb44b}{, 44b}, \underline{\NWlink{nuweb58b}{58b}}\NWlink{nuweb61a}{, 61a}\NWlink{nuweb68}{, 68}.
...
\item \verb@write_algo_states_to_disk_p@: \NWlink{nuweb28}{28}, \underline{\NWlink{nuweb38a}{38a}}\NWlink{nuweb40a}{, 40a}\NWlink{nuweb40c}{c}\NWlink{nuweb43c}{, 43c}\NWlink{nuweb68}{, 68}\NWlink{nuweb69}{, 69}.
\end{list}} 
%------------------------------------------------------
...
\NWtarget{nuweb74}{} \verb@"../src/lib/problem_one_horse_multiple_flies.py"@\nobreak\ {\footnotesize {74}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\NWtarget{nuweb75a}{} $\langle\,${\itshape Relevant imports}\nobreak\ {\footnotesize {75a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@from colorama import Fore, Style@\\
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb75b}{} $\langle\,${\itshape Set up logging information relevant to this module}\nobreak\ {\footnotesize {75b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@logger=logging.getLogger(__name__)@\\
\mbox{}\verb@logging.basicConfig(level=logging.DEBUG)@\\
...
\NWtarget{nuweb76a}{} $\langle\,${\itshape Define key-press handler}\nobreak\ {\footnotesize {76a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@# The key-stack argument is mutable! I am using this hack to my advantage.@\\
...
\NWtarget{nuweb76b}{} $\langle\,${\itshape Start entering input from the command-line}\nobreak\ {\footnotesize {76b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb76c}{} $\langle\,${\itshape Set speed and number of flies}\nobreak\ {\footnotesize {76c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb77a}{} $\langle\,${\itshape Select algorithm to execute}\nobreak\ {\footnotesize {77a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb77b}{} $\langle\,${\itshape Generate a bunch of uniform or non-uniform random points on the canvas}\nobreak\ {\footnotesize {77b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@numpts = int(raw_input("\n" + Fore.YELLOW+\@\\
\mbox{}\verb@                       "How many points should I generate?: "+\@\\
...
\NWtarget{nuweb78a}{} $\langle\,${\itshape Clear canvas and states of all objects}\nobreak\ {\footnotesize {78a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@run.clearAllStates()@\\
\mbox{}\verb@ax.cla()@\\
...
\NWtarget{nuweb78b}{} $\langle\,${\itshape Set up interactive canvas}\nobreak\ {\footnotesize {78b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@fig, ax =  plt.subplots()@\\
...
\NWtarget{nuweb79a}{} $\langle\,${\itshape Local data-structures}\nobreak\ {\footnotesize {79a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb79b}{} $\langle\,${\itshape Methods for \verb|MultipleFliesInput|}\nobreak\ {\footnotesize {79b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@def clearAllStates (self):@\\
\mbox{}\verb@   self.sites = []@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb79b}{79b}\NWlink{nuweb79c}{c}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb79a}{79a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@clearAllStates@\nobreak\ \NWlink{nuweb77b}{77b}\NWlink{nuweb78a}{, 78a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb79c}{} $\langle\,${\itshape Methods for \verb|MultipleFliesInput|}\nobreak\ {\footnotesize {79c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb81a}{} $\langle\,${\itshape Algorithms for multiple flies}\nobreak\ {\footnotesize {81a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb81b}{} $\langle\,${\itshape Definition of the \verb|FlyState| class}\nobreak\ {\footnotesize {81b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb82a}{} $\langle\,${\itshape Find the $k$-nearest sites to \verb|inithorseposn| for $k=$\verb|number_of_flies| and claim them}\nobreak\ {\footnotesize {82a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@from sklearn.neighbors import NearestNeighbors@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb82b}{} $\langle\,${\itshape Initialize one \verb|FlyState| object per fly for all flies}\nobreak\ {\footnotesize {82b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@flystates = []@\\
...
\NWtarget{nuweb83a}{} $\langle\,${\itshape Find the index of the fly \bm{F} which can meet the horse at the earliest, the rendezvous point $R$, and time till rendezvous}\nobreak\ {\footnotesize {83a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@imin  = 0@\\
...
%{python-mode}%
\begin{flushleft} \small\label{scrap121}\raggedright\small
\NWtarget{nuweb83b}{} $\langle\,${\itshape Definition of method \verb|rendezvous_time_and_point_if_selected_by_horse|}\nobreak\ {\footnotesize {83b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb84a}{} $\langle\,${\itshape Helper functions for \verb|algo_greedy_earliest_capture|}\nobreak\ {\footnotesize {84a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb84b}{} $\langle\,${\itshape Update fly trajectory in each \verb|FlyState| object till \bm{F} meets the horse at $R$}\nobreak\ {\footnotesize {84b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb84c}{} $\langle\,${\itshape Definition of method \verb|update_fly_trajectory|}\nobreak\ {\footnotesize {84c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb84d}{} $\langle\,${\itshape Move towards the provided rendezvous point}\nobreak\ {\footnotesize {84d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb85a}{} $\langle\,${\itshape Continue moving towards the site}\nobreak\ {\footnotesize {85a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb85b}{} $\langle\,${\itshape Move towards the site mark site as serviced and then head towards rendezvous point}\nobreak\ {\footnotesize {85b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb85c}{} $\langle\,${\itshape Update \verb|current_horse_posn| and horse trajectory}\nobreak\ {\footnotesize {85c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb85d}{} $\langle\,${\itshape Deploy \bm{F} to an unclaimed site if one exists and claim that site, otherwise retire \bm{F}}\nobreak\ {\footnotesize {85d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\NWtarget{nuweb86a}{} $\langle\,${\itshape Calculate value of \verb|all_flies_retired_p|}\nobreak\ {\footnotesize {86a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@acc = True @\\
\mbox{}\verb@for i in range(number_of_flies):@\\
...
\NWtarget{nuweb86b}{} $\langle\,${\itshape Set algo-state and input-output files config}\nobreak\ {\footnotesize {86b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb86c}{} $\langle\,${\itshape Write algorithms current state to file, if \verb|write_algo_states_to_disk_p == True|}\nobreak\ {\footnotesize {86c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
%{python-mode}%
\begin{flushleft} \small\label{scrap133}\raggedright\small
\NWtarget{nuweb87a}{} $\langle\,${\itshape Write input and output to file if \verb|write_io_p == True|}\nobreak\ {\footnotesize {87a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb87b}{} $\langle\,${\itshape Animate compute tour if \verb|animate_tour_p == True|}\nobreak\ {\footnotesize {87b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb87c}{} $\langle\,${\itshape Return multiple flies tour}\nobreak\ {\footnotesize {87c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb88}{} $\langle\,${\itshape Plotting routines}\nobreak\ {\footnotesize {88}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb89a}{} $\langle\,${\itshape Animation routines}\nobreak\ {\footnotesize {89a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb89b}{} $\langle\,${\itshape Set up configurations and parameters for all necessary graphics}\nobreak\ {\footnotesize {89b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@plt.rc('text', usetex=True)@\\
...
\NWtarget{nuweb91a}{} $\langle\,${\itshape Parse trajectory information and convert trajectory representation to leg list form}\nobreak\ {\footnotesize {91a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\NWtarget{nuweb91b}{} $\langle\,${\itshape Construct and store every frame of the animation in the \verb|ims| array}\nobreak\ {\footnotesize {91b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb93}{} $\langle\,${\itshape Define discretization function for a leg of the horse or fly tour}\nobreak\ {\footnotesize {93}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@def discretize_leg(pts):@\\
...
\NWtarget{nuweb94}{} $\langle\,${\itshape Write animation of tour to disk and display in live window}\nobreak\ {\footnotesize {94}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@from colorama import Back @\\
...
\NWtarget{nuweb96}{} \verb@"../src/expts/expt_decrease_in_tour_length_with_larger_number_of_drones.py"@\nobreak\ {\footnotesize {96}}$\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import sys, os@\\
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item $\langle\,$Algorithms for multiple flies\nobreak\ {\footnotesize \NWlink{nuweb81a}{81a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
\item $\langle\,$Animate compute tour if \verb|animate_tour_p == True|\nobreak\ {\footnotesize \NWlink{nuweb87b}{87b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Animation routines\nobreak\ {\footnotesize \NWlink{nuweb89a}{89a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
\item $\langle\,$Calculate value of \verb|all_flies_retired_p|\nobreak\ {\footnotesize \NWlink{nuweb86a}{86a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Clear canvas and states of all objects\nobreak\ {\footnotesize \NWlink{nuweb78a}{78a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
\item $\langle\,$Construct and store every frame of the animation in the \verb|ims| array\nobreak\ {\footnotesize \NWlink{nuweb91b}{91b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb89a}{89a}.}
\item $\langle\,$Continue moving towards the site\nobreak\ {\footnotesize \NWlink{nuweb85a}{85a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84c}{84c}.}
\item $\langle\,$Define discretization function for a leg of the horse or fly tour\nobreak\ {\footnotesize \NWlink{nuweb93}{93}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb91b}{91b}.}
\item $\langle\,$Define key-press handler\nobreak\ {\footnotesize \NWlink{nuweb76a}{76a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
\item $\langle\,$Definition of method \verb|rendezvous_time_and_point_if_selected_by_horse|\nobreak\ {\footnotesize \NWlink{nuweb83b}{83b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81b}{81b}.}
\item $\langle\,$Definition of method \verb|update_fly_trajectory|\nobreak\ {\footnotesize \NWlink{nuweb84c}{84c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81b}{81b}.}
\item $\langle\,$Definition of the \verb|FlyState| class\nobreak\ {\footnotesize \NWlink{nuweb81b}{81b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Deploy \bm{F} to an unclaimed site if one exists and claim that site, otherwise retire \bm{F}\nobreak\ {\footnotesize \NWlink{nuweb85d}{85d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Find the $k$-nearest sites to \verb|inithorseposn| for $k=$\verb|number_of_flies| and claim them\nobreak\ {\footnotesize \NWlink{nuweb82a}{82a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Find the index of the fly \bm{F} which can meet the horse at the earliest, the rendezvous point $R$, and time till rendezvous\nobreak\ {\footnotesize \NWlink{nuweb83a}{83a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Generate a bunch of uniform or non-uniform random points on the canvas\nobreak\ {\footnotesize \NWlink{nuweb77b}{77b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76a}{76a}.}
\item $\langle\,$Helper functions for \verb|algo_greedy_earliest_capture|\nobreak\ {\footnotesize \NWlink{nuweb84a}{84a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Initialize one \verb|FlyState| object per fly for all flies\nobreak\ {\footnotesize \NWlink{nuweb82b}{82b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Local data-structures\nobreak\ {\footnotesize \NWlink{nuweb79a}{79a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
\item $\langle\,$Methods for \verb|MultipleFliesInput|\nobreak\ {\footnotesize \NWlink{nuweb79b}{79b}\NWlink{nuweb79c}{c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb79a}{79a}.}
\item $\langle\,$Move towards the provided rendezvous point\nobreak\ {\footnotesize \NWlink{nuweb84d}{84d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84c}{84c}.}
\item $\langle\,$Move towards the site mark site as serviced and then head towards rendezvous point\nobreak\ {\footnotesize \NWlink{nuweb85b}{85b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84c}{84c}.}
\item $\langle\,$Parse trajectory information and convert trajectory representation to leg list form\nobreak\ {\footnotesize \NWlink{nuweb91a}{91a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb89a}{89a}.}
\item $\langle\,$Plotting routines\nobreak\ {\footnotesize \NWlink{nuweb88}{88}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
\item $\langle\,$Relevant imports\nobreak\ {\footnotesize \NWlink{nuweb75a}{75a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
\item $\langle\,$Return multiple flies tour\nobreak\ {\footnotesize \NWlink{nuweb87c}{87c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Select algorithm to execute\nobreak\ {\footnotesize \NWlink{nuweb77a}{77a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76b}{76b}.}
\item $\langle\,$Set algo-state and input-output files config\nobreak\ {\footnotesize \NWlink{nuweb86b}{86b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Set speed and number of flies\nobreak\ {\footnotesize \NWlink{nuweb76c}{76c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb76b}{76b}.}
\item $\langle\,$Set up configurations and parameters for all necessary graphics\nobreak\ {\footnotesize \NWlink{nuweb89b}{89b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb89a}{89a}.}
\item $\langle\,$Set up interactive canvas\nobreak\ {\footnotesize \NWlink{nuweb78b}{78b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb74}{74}.}
...
\item $\langle\,$Update fly trajectory in each \verb|FlyState| object till \bm{F} meets the horse at $R$\nobreak\ {\footnotesize \NWlink{nuweb84b}{84b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Update \verb|current_horse_posn| and horse trajectory\nobreak\ {\footnotesize \NWlink{nuweb85c}{85c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Write algorithms current state to file, if \verb|write_algo_states_to_disk_p == True|\nobreak\ {\footnotesize \NWlink{nuweb86c}{86c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\item $\langle\,$Write animation of tour to disk and display in live window\nobreak\ {\footnotesize \NWlink{nuweb94}{94}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb89a}{89a}.}
\item $\langle\,$Write input and output to file if \verb|write_io_p == True|\nobreak\ {\footnotesize \NWlink{nuweb87a}{87a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb81a}{81a}.}
\end{list}}
\section{Chapter Index of Identifiers}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@clearAllStates@: \NWlink{nuweb77b}{77b}\NWlink{nuweb78a}{, 78a}, \underline{\NWlink{nuweb79b}{79b}}.
\item \verb@getTour@: \NWlink{nuweb77a}{77a}, \underline{\NWlink{nuweb79c}{79c}}.
\item \verb@meeting_time_horse_fly_opp_dir@: \NWlink{nuweb83b}{83b}, \underline{\NWlink{nuweb84a}{84a}}.
\item \verb@rendezvous_time_and_point_if_selected_by_horse@: \NWlink{nuweb83a}{83a}, \underline{\NWlink{nuweb83b}{83b}}.
\item \verb@wrapperkeyPressHandler@: \underline{\NWlink{nuweb76a}{76a}}\NWlink{nuweb78b}{, 78b}.
\end{list}} 
%------------------------------------------------------
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@"../main.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb13a}{13a}.}
\item \verb@"../src/expts/expt_collinear_snap_length_increase.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb68}{68}.}
\item \verb@"../src/expts/expt_decrease_in_tour_length_with_larger_number_of_drones.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb96}{96}.}
\item \verb@"../src/expts/expt_interesting_example_gincex.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb69}{69}.}
\item \verb@"../src/lib/problem_classic_horsefly.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb20a}{20a}.}
\item \verb@"../src/lib/problem_one_horse_multiple_flies.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb74}{74}.}
