...
\mbox{}\verb@@\\
\mbox{}\verb@ax.set_title("Number of sites: " + str(len(sites)), fontsize=25)@\\
\mbox{}\verb@ax.set_xlabel(r"$\varphi$ = " + str(phi) + "  Number of drones is " + str(number_of_flies), @\\
\mbox{}\verb@              fontsize=20)@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb86}{} $\langle\,${\itshape Parse trajectory information and convert trajectory representation to leg list form}\nobreak\ {\footnotesize {86}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\NWtarget{nuweb87}{} $\langle\,${\itshape Construct and store every frame of the animation in the \verb|ims| array}\nobreak\ {\footnotesize {87}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\mbox{}\verb@ims               = []@\\
\mbox{}\verb@fly_sites_so_far  = [[] for i in range(number_of_flies)] # list of sites for each fly that have been covered so far@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@    for fly_leg in fly_legs:@\\
...
\mbox{}\verb@        current_fly_posns  = []@\\
\mbox{}\verb@        for j in range(len(fly_legs_disc)):@\\
\mbox{}\verb@              if fly_legs_disc[j] != None:@\\
\mbox{}\verb@                    print "********************"@\\
\mbox{}\verb@                    print Fore.RED, "Type of leg: ", fly_legs_disc[j]['legtype']@\\
\mbox{}\verb@                    print Fore.GREEN@\\
\mbox{}\verb@                    utils_algo.print_list(fly_legs_disc[j]['points'])@\\
\mbox{}\verb@                    print Style.RESET_ALL@\\
\mbox{}\verb@                    current_fly_posns.append(fly_legs_disc[j]['points'][k])@\\
\mbox{}\verb@                    # update the fly_points_so_far thing here depending on legtype@\\
\mbox{}\verb@                    print Fore.RED, j, " ", k, Style.RESET_ALL@\\
\mbox{}\verb@                    if fly_legs_disc[j]['legtype'] == 'gsg' and k==9:@\\
\mbox{}\verb@                          fly_sites_so_far[j].append(fly_legs_disc[j]['points'][k])@\\
\mbox{}\verb@              else: @\\
\mbox{}\verb@                    current_fly_posns.append(None)@\\
\mbox{}\verb@        print "................................................."@\\
\mbox{}\verb@        print "Current horse position is", (current_horse_posn)@\\
\mbox{}\verb@        print "Current positions of flies are "@\\
\mbox{}\verb@        utils_algo.print_list(current_fly_posns)@\\
\mbox{}\verb@@\\
\mbox{}\verb@        ####----------------------------------------------------------------@\\
\mbox{}\verb@        ####.................... Graphics code goes here ...................@\\
\mbox{}\verb@        ####----------------------------------------------------------------@\\
\mbox{}\verb@        # Plot sites as black circles@\\
\mbox{}\verb@        # Plot trajectory of horse@\\
\mbox{}\verb@        # Plot trajectory of flies (no markers)@\\
\mbox{}\verb@        # Plot the end points of trajectories @\\
\mbox{}\verb@        # Plot currently covered sites as colored circles@\\
\mbox{}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@print "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"@\\
\mbox{}\verb@utils_algo.print_list(fly_sites_so_far)@\\
\mbox{}\verb@print "^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^"@\\
...
\NWtarget{nuweb88a}{} $\langle\,${\itshape Define discretization function for a leg of the horse or fly tour}\nobreak\ {\footnotesize {88a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@def discretize_leg(pts):@\\
...
\NWtarget{nuweb88b}{} $\langle\,${\itshape Write animation of tour to disk and display in live window}\nobreak\ {\footnotesize {88b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@from colorama import Back @\\
...
\item $\langle\,$Construct and store every frame of the animation in the \verb|ims| array\nobreak\ {\footnotesize \NWlink{nuweb87}{87}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84a}{84a}.}
...
\item $\langle\,$Define discretization function for a leg of the horse or fly tour\nobreak\ {\footnotesize \NWlink{nuweb88a}{88a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb87}{87}.}
...
\item $\langle\,$Write animation of tour to disk and display in live window\nobreak\ {\footnotesize \NWlink{nuweb88b}{88b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb84a}{84a}.}
