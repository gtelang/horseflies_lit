...
me to write a customized \texttt{debug} function that let's me format the log messages
according to the frame level. I learned this trick from the following Stack Overflow post
\url{https://stackoverflow.com/a/5500099/505306}. 

\begin{flushleft} \small
\begin{minipage}{\linewidth}\label{scrap15}\raggedright\small
\NWtarget{nuweb22}{} $\langle\,${\itshape Set up logging information relevant to this module}\nobreak\ {\footnotesize {22}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb23a}{} $\langle\,${\itshape Define key-press handler}\nobreak\ {\footnotesize {23a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb23b}{} $\langle\,${\itshape Start entering input from the command-line}\nobreak\ {\footnotesize {23b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb30}{30}, \verb@algo_greedy_incremental_insertion,@\nobreak\ \NWlink{nuweb34a}{34a}, \verb@plotTour@\nobreak\ \NWlink{nuweb47}{47}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@HorseFlyInput@\nobreak\ \NWlink{nuweb26}{26}, \verb@wrapperkeyPressHandler@\nobreak\ \NWlink{nuweb23a}{23a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb26}{} $\langle\,${\itshape Local data-structures for classic horsefly}\nobreak\ {\footnotesize {26}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@HorseFlyInput@\nobreak\ \NWlink{nuweb25b}{25b}.\item \NWtxtIdentsUsed\nobreak\  \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb42}{42}, \verb@self.sites,@\nobreak\ \NWlink{nuweb42}{42}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb28}{28}\NWlink{nuweb29}{, 29}\NWlink{nuweb30}{, 30}\NWlink{nuweb34a}{, 34a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb30}{30}, \verb@tour_length@\nobreak\ \NWlink{nuweb45}{45}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb30}{} $\langle\,${\itshape Algorithms for classic horsefly}\nobreak\ {\footnotesize {30}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb28}{28}\NWlink{nuweb29}{, 29}\NWlink{nuweb30}{, 30}\NWlink{nuweb34a}{, 34a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb23b}{23b}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb45}{45}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb46}{46}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\mbox{}\verb@                                      render_algo_states_to_image_files_p = True,@\\
...
\mbox{}\verb@      @\hbox{$\langle\,${\itshape If \verb|render_algo_states_to_image_files_p| $==$ \verb|True|, make an animation of algorithm states}\nobreak\ {\footnotesize \NWlink{nuweb40a}{40a}}$\,\rangle$}\verb@@\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb28}{28}\NWlink{nuweb29}{, 29}\NWlink{nuweb30}{, 30}\NWlink{nuweb34a}{, 34a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_greedy_incremental_insertion,@\nobreak\ \NWlink{nuweb23b}{23b}, \verb@render_algo_states_to_image_files_p@\nobreak\ \NWlink{nuweb36b}{36b}\NWlink{nuweb40a}{, 40a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb36a}{} $\langle\,${\itshape Write algorithm's current state to file}\nobreak\ {\footnotesize {36a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\mbox{}\verb@     @\hbox{$\langle\,${\itshape If \verb|render_algo_states_to_image_files_p| flag is set to \verb|True|, render current algorithm state to file}\nobreak\ {\footnotesize \NWlink{nuweb36b}{36b}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb36b}{} $\langle\,${\itshape If \verb|render_algo_states_to_image_files_p| flag is set to \verb|True|, render current algorithm state to file}\nobreak\ {\footnotesize {36b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@import utils_algo@\\
\mbox{}\verb@if render_algo_states_to_image_files_p:@\\
...
\item \NWtxtIdentsUsed\nobreak\  \verb@render_algo_states_to_image_files_p@\nobreak\ \NWlink{nuweb34a}{34a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Set up plotting area and canvas, fig, ax, and other configs}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@from matplotlib import rc@\\
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Extract $x$ and $y$ coordinates of the points on the horse, fly tours, visited and unvisited sites}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
\mbox{}\verb@@\\
...
\NWtarget{nuweb38a}{} $\langle\,${\itshape Mark initial position of horse and fly boldly on canvas}\nobreak\ {\footnotesize {38a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ax.add_patch( mpl.patches.Circle( inithorseposn, \@\\
...
\NWtarget{nuweb38b}{} $\langle\,${\itshape Draw horse and fly-tours}\nobreak\ {\footnotesize {38b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb38c}{} $\langle\,${\itshape Place numbered markers on visited sites to mark the order of visitation explicitly}\nobreak\ {\footnotesize {38c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb38d}{} $\langle\,${\itshape Draw unvisited sites as filled blue circles}\nobreak\ {\footnotesize {38d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb38e}{} $\langle\,${\itshape Give metainformation about current picture as headers and footers}\nobreak\ {\footnotesize {38e}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb39a}{} $\langle\,${\itshape Write image file}\nobreak\ {\footnotesize {39a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb39b}{} $\langle\,${\itshape Write input and output to file}\nobreak\ {\footnotesize {39b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb40a}{} $\langle\,${\itshape If \verb|render_algo_states_to_image_files_p| $==$ \verb|True|, make an animation of algorithm states}\nobreak\ {\footnotesize {40a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@if render_algo_states_to_image_files_p:@\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb40c}{40c}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb34a}{34a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@compute_collinear_horseflies_tour@\nobreak\ \NWlink{nuweb44b}{44b}.\item \NWtxtIdentsUsed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb40c}{40c}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb42}{} $\langle\,${\itshape Define various insertion policy classes}\nobreak\ {\footnotesize {42}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb34a}{34a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@self.horse_tour@\nobreak\ \NWlink{nuweb44b}{44b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb43b}{, 43b}\NWlink{nuweb43d}{d}\NWlink{nuweb44b}{, 44b}, \verb@self.sites,@\nobreak\ \NWlink{nuweb26}{26}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb43b}{43b}\NWlink{nuweb44b}{, 44b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb43a}{} $\langle\,${\itshape Methods for \verb|PolicyBestInsertionNaive|}\nobreak\ {\footnotesize {43a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb43d}{43d}\NWlink{nuweb44a}{, 44a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb43b}{} $\langle\,${\itshape Compute the length of the tour that currently services the visited sites}\nobreak\ {\footnotesize {43b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsDefed\nobreak\  \verb@current_tour_length@\nobreak\ \NWlink{nuweb43d}{43d}.\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb41a}{41a}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb42}{42}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb42}{42}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb43c}{} $\langle\,${\itshape Set up tracking variables local to this iteration}\nobreak\ {\footnotesize {43c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ibest                = 0@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb43a}{43a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least@\nobreak\ \NWlink{nuweb43d}{43d}, \verb@ibest,@\nobreak\ \NWlink{nuweb43d}{43d}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb43d}{} $\langle\,${\itshape If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}}\nobreak\ {\footnotesize {43d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb43a}{43a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb41a}{41a}, \verb@current_tour_length@\nobreak\ \NWlink{nuweb43b}{43b}, \verb@delta_increase_least@\nobreak\ \NWlink{nuweb43c}{43c}, \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb43a}{43a}, \verb@ibest,@\nobreak\ \NWlink{nuweb43c}{43c}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb42}{42}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb44a}{} $\langle\,${\itshape Find the unvisited site which on insertion increases tour-length by the least amount}\nobreak\ {\footnotesize {44a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb44b}{} $\langle\,${\itshape Update states for \texttt{PolicyBestInsertionNaive}}\nobreak\ {\footnotesize {44b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb45}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {45}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb28}{28}\NWlink{nuweb30}{, 30}\NWlink{nuweb47}{, 47}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb45}{45}\NWlink{nuweb46}{, 46}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb30}{30}\NWlink{nuweb40b}{, 40b}\NWlink{nuweb47}{, 47}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb28}{28}\NWlink{nuweb29}{, 29}\NWlink{nuweb30}{, 30}\NWlink{nuweb34a}{, 34a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
\item $\langle\,$Clear canvas and states of all objects\nobreak\ {\footnotesize \NWlink{nuweb25a}{25a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23a}{23a}.}
\item $\langle\,$Compute the length of the tour that currently services the visited sites\nobreak\ {\footnotesize \NWlink{nuweb43b}{43b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb43a}{43a}.}
...
\item $\langle\,$Define various insertion policy classes\nobreak\ {\footnotesize \NWlink{nuweb42}{42}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34a}{34a}.}
...
\item $\langle\,$Find the unvisited site which on insertion increases tour-length by the least amount\nobreak\ {\footnotesize \NWlink{nuweb44a}{44a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb43a}{43a}.}
\item $\langle\,$Generate a bunch of uniform or non-uniform random points on the canvas\nobreak\ {\footnotesize \NWlink{nuweb24}{24}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb23a}{23a}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb45}{45}\NWlink{nuweb46}{, 46}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
...
\item $\langle\,$Methods for \verb|PolicyBestInsertionNaive|\nobreak\ {\footnotesize \NWlink{nuweb43a}{43a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb42}{42}.}
...
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb47}{47}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
...
\item $\langle\,$Set up tracking variables local to this iteration\nobreak\ {\footnotesize \NWlink{nuweb43c}{43c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb43a}{43a}.}
...
\item $\langle\,$Update states for \texttt{PolicyBestInsertionNaive}\nobreak\ {\footnotesize \NWlink{nuweb44b}{44b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb43a}{43a}.}
...
\item $\langle\,$Write image file\nobreak\ {\footnotesize \NWlink{nuweb39a}{39a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb36b}{36b}.}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb23b}{23b}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}, \underline{\NWlink{nuweb30}{30}}.
\item \verb@algo_greedy_incremental_insertion,@: \NWlink{nuweb23b}{23b}, \underline{\NWlink{nuweb34a}{34a}}.
\item \verb@compute_collinear_horseflies_tour@: \underline{\NWlink{nuweb41b}{41b}}\NWlink{nuweb44b}{, 44b}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb43b}{, 43b}\NWlink{nuweb43d}{d}.
\item \verb@current_tour_length@: \underline{\NWlink{nuweb43b}{43b}}\NWlink{nuweb43d}{, 43d}.
\item \verb@delta_increase_least@: \underline{\NWlink{nuweb43c}{43c}}\NWlink{nuweb43d}{, 43d}.
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb43a}{43a}}\NWlink{nuweb43d}{, 43d}\NWlink{nuweb44a}{, 44a}.
\item \verb@HorseFlyInput@: \NWlink{nuweb25b}{25b}, \underline{\NWlink{nuweb26}{26}}.
\item \verb@ibest,@: \underline{\NWlink{nuweb43c}{43c}}\NWlink{nuweb43d}{, 43d}.
\item \verb@io_file_name,@: \underline{\NWlink{nuweb34b}{34b}}\NWlink{nuweb39b}{, 39b}.
\item \verb@logger@: \NWlink{nuweb22}{22}, \underline{\NWlink{nuweb34b}{34b}}.
\item \verb@plotTour@: \NWlink{nuweb23b}{23b}, \underline{\NWlink{nuweb47}{47}}.
\item \verb@render_algo_states_to_image_files_p@: \underline{\NWlink{nuweb34a}{34a}}\NWlink{nuweb36b}{, 36b}\NWlink{nuweb40a}{, 40a}.
\item \verb@run_handler@: \underline{\NWlink{nuweb21a}{21a}}.
\item \verb@self.horse_tour@: \underline{\NWlink{nuweb42}{42}}\NWlink{nuweb44b}{, 44b}.
\item \verb@self.inithorseposn,@: \NWlink{nuweb26}{26}, \underline{\NWlink{nuweb42}{42}}\NWlink{nuweb43b}{, 43b}\NWlink{nuweb43d}{d}\NWlink{nuweb44b}{, 44b}.
\item \verb@self.sites,@: \NWlink{nuweb26}{26}, \underline{\NWlink{nuweb42}{42}}.
\item \verb@self.visited_sites,@: \underline{\NWlink{nuweb42}{42}}\NWlink{nuweb43b}{, 43b}\NWlink{nuweb44b}{, 44b}.
\item \verb@single_site_solution@: \underline{\NWlink{nuweb40c}{40c}}\NWlink{nuweb41a}{, 41a}\NWlink{nuweb41b}{b}.
\item \verb@tour_length@: \NWlink{nuweb28}{28}\NWlink{nuweb30}{, 30}, \underline{\NWlink{nuweb45}{45}}\NWlink{nuweb47}{, 47}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb30}{30}\NWlink{nuweb40b}{, 40b}, \underline{\NWlink{nuweb46}{46}}\NWlink{nuweb47}{, 47}.
\item \verb@wrapperkeyPressHandler@: \underline{\NWlink{nuweb23a}{23a}}\NWlink{nuweb25b}{, 25b}.
\end{list}} 
