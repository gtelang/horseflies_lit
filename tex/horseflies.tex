...
libraries (mostly CGAL and VTK) using SWIG (\url{http://www.swig.org/}). This is either 
...
be done directly to the \texttt{.web} files. These .web files should then be weaved and tangled 
using thescript \texttt{weave-tangle.sh} in the \texttt{webs} directory. 
...
\item \crunchy{Utility Files}  All such utility files are in the directory \texttt{src/lib/}. 
 These files contain common utility functions that will be useful 
 for manipulating data-structures, common plotting and graphics routines 
 for all horsefly-type problems. All such files have the prefix \verb|utils_*|. 
 These Python files are generated from the single \verb|.web| file \verb|utils.web| 
...
\mbox{}\verb@      @\hbox{$\langle\,${\itshape Set log and input-output file config}\nobreak\ {\footnotesize \NWlink{nuweb33a}{33a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
...
\mbox{}\verb@      @\hbox{$\langle\,${\itshape Initialize data-structures}\nobreak\ {\footnotesize \NWlink{nuweb34a}{34a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
\mbox{}\verb@      while @\hbox{$\langle\,${\itshape There is at-least one unvisited site}\nobreak\ {\footnotesize \NWlink{nuweb34b}{34b}}$\,\rangle$}\verb@ :@\\
...
\mbox{}\verb@         @\hbox{$\langle\,${\itshape Update list of visited and unvisited sites}\nobreak\ {\footnotesize \NWlink{nuweb35a}{35a}}$\,\rangle$}\verb@@\\
...
\NWtarget{nuweb33a}{} $\langle\,${\itshape Set log and input-output file config}\nobreak\ {\footnotesize {33a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\NWtarget{nuweb34a}{} $\langle\,${\itshape Initialize data-structures}\nobreak\ {\footnotesize {34a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@logger.debug("Finished initializing data-structures")@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb34b}{} $\langle\,${\itshape There is at-least one unvisited site}\nobreak\ {\footnotesize {34b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@True @{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
...
\NWtarget{nuweb34c}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {34c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@def compute_collinear_horseflies_tour_length(sites, inithorseposn, phi):@\\
\mbox{}\verb@       pass@\\
\mbox{}\verb@          @\\
\mbox{}\verb@@{\NWsep}
\end{list}
...
\NWtarget{nuweb34d}{} $\langle\,${\itshape Use insertion policy to find the cheapest site to insert into current tour}\nobreak\ {\footnotesize {34d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@pass   @\\
...
\NWtarget{nuweb35a}{} $\langle\,${\itshape Update list of visited and unvisited sites}\nobreak\ {\footnotesize {35a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb35b}{} $\langle\,${\itshape Write algorithm's current state to file}\nobreak\ {\footnotesize {35b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb35c}{} $\langle\,${\itshape Write input and output to file}\nobreak\ {\footnotesize {35c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb35d}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {35d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@   @\\
...
\NWtarget{nuweb36a}{} $\langle\,${\itshape Define various insertion policy classes}\nobreak\ {\footnotesize {36a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\mbox{}\verb@    @\\
\mbox{}\verb@         # Remember input data for future processing@\\
\mbox{}\verb@         self.sites           = sites@\\
\mbox{}\verb@         self.inithorseposn   = inithorseposn@\\
\mbox{}\verb@         self.phi             = phi@\\
\mbox{}\verb@@\\
\mbox{}\verb@         # Initialize data-elements for whom I am @\\
\mbox{}\verb@         # responsible for keeping track and manipulating.@\\
\mbox{}\verb@         self.unvisited_sites = [] # an index list that indexes into self.sites@\\
\mbox{}\verb@         self.horse_tour      = None@\\
\mbox{}\verb@@\\
\mbox{}\verb@    @\hbox{$\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize \NWlink{nuweb36b}{36b}, \ldots\ }$\,\rangle$}\verb@@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb36b}{} $\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize {36b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@def suggest_site_for_insertion(self):@\\
\mbox{}\verb@      pass@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb36b}{36b}\NWlink{nuweb37a}{, 37a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb36a}{36a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@suggest_site_for_insertion@\nobreak\ \NWtxtIdentsNotUsed.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@def update_state(self):@\\
\mbox{}\verb@     pass@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb37b}{37b}\NWlink{nuweb38}{, 38}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb27}{27}\NWlink{nuweb29}{, 29}\NWlink{nuweb39}{, 39}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb38}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {38}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb39}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {39}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb37b}{37b}\NWlink{nuweb38}{, 38}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
\item $\langle\,$Methods for \verb|PolicyNaive|\nobreak\ {\footnotesize \NWlink{nuweb36b}{36b}\NWlink{nuweb37a}{, 37a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb36a}{36a}.}
...
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb34c}{34c}}.
\item \verb@HorseFlyInput@: \NWlink{nuweb24b}{24b}, \underline{\NWlink{nuweb25}{25}}.
\item \verb@plotTour@: \NWlink{nuweb22b}{22b}, \underline{\NWlink{nuweb39}{39}}.
\item \verb@run_handler@: \underline{\NWlink{nuweb21a}{21a}}.
\item \verb@suggest_site_for_insertion@: \underline{\NWlink{nuweb36b}{36b}}.
\item \verb@tour_length@: \NWlink{nuweb27}{27}\NWlink{nuweb29}{, 29}, \underline{\NWlink{nuweb37b}{37b}}\NWlink{nuweb39}{, 39}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb29}{29}, \underline{\NWlink{nuweb38}{38}}\NWlink{nuweb39}{, 39}.
\item \verb@update_state@: \underline{\NWlink{nuweb37a}{37a}}.
