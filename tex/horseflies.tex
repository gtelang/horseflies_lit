...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtFileDefBy\ \NWlink{nuweb17a}{17a}\NWlink{nuweb17b}{b}\NWlink{nuweb18a}{, 18a}\NWlink{nuweb18b}{b}\NWlink{nuweb19}{, 19}.
...
\NWtarget{nuweb22a}{} $\langle\,${\itshape Define key-press handler}\nobreak\ {\footnotesize {22a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb22b}{} $\langle\,${\itshape Start entering input from the command-line}\nobreak\ {\footnotesize {22b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@HorseFlyInput@\nobreak\ \NWlink{nuweb25}{25}, \verb@wrapperkeyPressHandler@\nobreak\ \NWlink{nuweb22a}{22a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb25}{} $\langle\,${\itshape Local data-structures for classic horsefly}\nobreak\ {\footnotesize {25}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb27}{27}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}\NWlink{nuweb32}{, 32}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb27}{27}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}\NWlink{nuweb32}{, 32}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_greedy_incremental_insertion,@\nobreak\ \NWlink{nuweb22b}{22b}, \verb@animate_algo_p@\nobreak\ \NWlink{nuweb36}{36}\NWlink{nuweb37b}{, 37b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb33a}{} $\langle\,${\itshape Set log, algo-state and input-output files config}\nobreak\ {\footnotesize {33a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@  @\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@io_file_name,@\nobreak\ \NWlink{nuweb37a}{37a}, \verb@logger@\nobreak\ \NWlink{nuweb33b}{33b}\NWlink{nuweb34a}{, 34a}\NWlink{nuweb34b}{b}\NWlink{nuweb37a}{, 37a}\NWlink{nuweb37c}{c}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb33b}{} $\langle\,${\itshape Set insertion policy class for current run}\nobreak\ {\footnotesize {33b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb34a}{} $\langle\,${\itshape Use insertion policy to find the cheapest site to insert into current tour}\nobreak\ {\footnotesize {34a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb34b}{} $\langle\,${\itshape Write algorithm's current state to file}\nobreak\ {\footnotesize {34b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb36}{} $\langle\,${\itshape If \verb|animate_algo_p| flag is set to \verb|True|, render current algorithm state to file}\nobreak\ {\footnotesize {36}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@import utils_algo@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32}{32}.
\item \NWtxtIdentsUsed\nobreak\  \verb@io_file_name,@\nobreak\ \NWlink{nuweb33a}{33a}, \verb@logger@\nobreak\ \NWlink{nuweb33a}{33a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape If \verb|animate_algo_p| $==$ \verb|True|, make an animation of algorithm states}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@if animate_algo_p:@\\
\mbox{}\verb@     import subprocess, os@\\
\mbox{}\verb@     os.chdir(dir_name)@\\
\mbox{}\verb@     subprocess.call( ['ffmpeg', '-r', '1',  '-i', 'algo_state_%05d.png', '-vcodec', 'mpeg4', '-r', '10' ,'algo_state_animation.avi']  )@\\
\mbox{}\verb@     os.chdir('../')@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb37c}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {37c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@sys.exit()@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32}{32}.
\item \NWtxtIdentsUsed\nobreak\  \verb@logger@\nobreak\ \NWlink{nuweb33a}{33a}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb44}{44}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb38}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {38}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb38}{38}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb32}{32}.
...
\NWtarget{nuweb40}{} $\langle\,${\itshape Define various insertion policy classes}\nobreak\ {\footnotesize {40}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb32}{32}.
\item \NWtxtIdentsDefed\nobreak\  \verb@self.horse_tour@\nobreak\ \NWlink{nuweb42b}{42b}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb25}{25}\NWlink{nuweb41b}{, 41b}\NWlink{nuweb41d}{d}\NWlink{nuweb42b}{, 42b}, \verb@self.sites,@\nobreak\ \NWlink{nuweb25}{25}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb41b}{41b}\NWlink{nuweb42b}{, 42b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41a}{} $\langle\,${\itshape Methods for \verb|PolicyNaive|}\nobreak\ {\footnotesize {41a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb41d}{41d}\NWlink{nuweb42a}{, 42a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41b}{} $\langle\,${\itshape Compute the length of the tour that currently services the visited sites}\nobreak\ {\footnotesize {41b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtIdentsDefed\nobreak\  \verb@current_tour_length@\nobreak\ \NWlink{nuweb41d}{41d}.\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb39a}{39a}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb40}{40}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb40}{40}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41c}{} $\langle\,${\itshape Set up tracking variables local to this iteration}\nobreak\ {\footnotesize {41c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ibest                = 0@\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb41a}{41a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least@\nobreak\ \NWlink{nuweb41d}{41d}, \verb@ibest,@\nobreak\ \NWlink{nuweb41d}{41d}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41d}{} $\langle\,${\itshape If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}}\nobreak\ {\footnotesize {41d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb41a}{41a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb39a}{39a}, \verb@current_tour_length@\nobreak\ \NWlink{nuweb41b}{41b}, \verb@delta_increase_least@\nobreak\ \NWlink{nuweb41c}{41c}, \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb41a}{41a}, \verb@ibest,@\nobreak\ \NWlink{nuweb41c}{41c}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb40}{40}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb41a}{41a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour@\nobreak\ \NWlink{nuweb39b}{39b}, \verb@self.horse_tour@\nobreak\ \NWlink{nuweb40}{40}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb40}{40}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb40}{40}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb43}{43}\NWlink{nuweb44}{, 44}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
...
\NWtarget{nuweb44}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {44}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb43}{43}\NWlink{nuweb44}{, 44}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb29}{29}\NWlink{nuweb37c}{, 37c}\NWlink{nuweb45}{, 45}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb21a}{21a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@plotTour@\nobreak\ \NWlink{nuweb22b}{22b}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb43}{43}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb44}{44}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb27}{27}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}\NWlink{nuweb32}{, 32}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
\item $\langle\,$Clear canvas and states of all objects\nobreak\ {\footnotesize \NWlink{nuweb24a}{24a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb22a}{22a}.}
...
\item $\langle\,$Define auxiliary helper functions\nobreak\ {\footnotesize \NWlink{nuweb38}{38}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32}{32}.}
...
\item $\langle\,$Define various insertion policy classes\nobreak\ {\footnotesize \NWlink{nuweb40}{40}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32}{32}.}
\item $\langle\,$Find the unvisited site which on insertion increases tour-length by the least amount\nobreak\ {\footnotesize \NWlink{nuweb42a}{42a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb41a}{41a}.}
\item $\langle\,$Generate a bunch of uniform or non-uniform random points on the canvas\nobreak\ {\footnotesize \NWlink{nuweb23}{23}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb22a}{22a}.}
\item $\langle\,$If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}\nobreak\ {\footnotesize \NWlink{nuweb41d}{41d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb41a}{41a}.}
\item $\langle\,$If \verb|animate_algo_p| $==$ \verb|True|, make an animation of algorithm states\nobreak\ {\footnotesize \NWlink{nuweb37b}{37b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32}{32}.}
\item $\langle\,$If \verb|animate_algo_p| flag is set to \verb|True|, render current algorithm state to file\nobreak\ {\footnotesize \NWlink{nuweb36}{36}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb34b}{34b}.}
\item $\langle\,$Local data-structures for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb25}{25}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb43}{43}\NWlink{nuweb44}{, 44}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
\item $\langle\,$Methods for \verb|PolicyNaive|\nobreak\ {\footnotesize \NWlink{nuweb41a}{41a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb40}{40}.}
...
\item $\langle\,$Return horsefly tour, along with additional information\nobreak\ {\footnotesize \NWlink{nuweb37c}{37c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32}{32}.}
...
\item $\langle\,$Set up interactive canvas\nobreak\ {\footnotesize \NWlink{nuweb24b}{24b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb21a}{21a}.}
\item $\langle\,$Set up tracking variables local to this iteration\nobreak\ {\footnotesize \NWlink{nuweb41c}{41c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb41a}{41a}.}
...
\item $\langle\,$Update states for \texttt{PolicyNaive}\nobreak\ {\footnotesize \NWlink{nuweb42b}{42b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb41a}{41a}.}
...
\item $\langle\,$Write input and output to file\nobreak\ {\footnotesize \NWlink{nuweb37a}{37a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb32}{32}.}
\end{list}}
\section{Chapter Index of Identifiers}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb22b}{22b}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}, \underline{\NWlink{nuweb29}{29}}.
\item \verb@algo_greedy_incremental_insertion,@: \NWlink{nuweb22b}{22b}, \underline{\NWlink{nuweb32}{32}}.
\item \verb@animate_algo_p@: \underline{\NWlink{nuweb32}{32}}\NWlink{nuweb36}{, 36}\NWlink{nuweb37b}{, 37b}.
\item \verb@compute_collinear_horseflies_tour@: \underline{\NWlink{nuweb39b}{39b}}\NWlink{nuweb42b}{, 42b}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb39a}{39a}}\NWlink{nuweb41b}{, 41b}\NWlink{nuweb41d}{d}.
\item \verb@current_tour_length@: \underline{\NWlink{nuweb41b}{41b}}\NWlink{nuweb41d}{, 41d}.
\item \verb@delta_increase_least@: \underline{\NWlink{nuweb41c}{41c}}\NWlink{nuweb41d}{, 41d}.
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb41d}{, 41d}\NWlink{nuweb42a}{, 42a}.
\item \verb@HorseFlyInput@: \NWlink{nuweb24b}{24b}, \underline{\NWlink{nuweb25}{25}}.
\item \verb@ibest,@: \underline{\NWlink{nuweb41c}{41c}}\NWlink{nuweb41d}{, 41d}.
\item \verb@io_file_name,@: \underline{\NWlink{nuweb33a}{33a}}\NWlink{nuweb37a}{, 37a}.
\item \verb@logger@: \underline{\NWlink{nuweb33a}{33a}}\NWlink{nuweb33b}{, 33b}\NWlink{nuweb34a}{, 34a}\NWlink{nuweb34b}{b}\NWlink{nuweb37a}{, 37a}\NWlink{nuweb37c}{c}.
\item \verb@plotTour@: \NWlink{nuweb22b}{22b}, \underline{\NWlink{nuweb45}{45}}.
\item \verb@run_handler@: \underline{\NWlink{nuweb21a}{21a}}.
\item \verb@self.horse_tour@: \underline{\NWlink{nuweb40}{40}}\NWlink{nuweb42b}{, 42b}.
\item \verb@self.inithorseposn,@: \NWlink{nuweb25}{25}, \underline{\NWlink{nuweb40}{40}}\NWlink{nuweb41b}{, 41b}\NWlink{nuweb41d}{d}\NWlink{nuweb42b}{, 42b}.
\item \verb@self.sites,@: \NWlink{nuweb25}{25}, \underline{\NWlink{nuweb40}{40}}.
\item \verb@self.visited_sites,@: \underline{\NWlink{nuweb40}{40}}\NWlink{nuweb41b}{, 41b}\NWlink{nuweb42b}{, 42b}.
\item \verb@single_site_solution@: \underline{\NWlink{nuweb38}{38}}\NWlink{nuweb39a}{, 39a}\NWlink{nuweb39b}{b}.
\item \verb@tour_length@: \NWlink{nuweb27}{27}\NWlink{nuweb29}{, 29}, \underline{\NWlink{nuweb43}{43}}\NWlink{nuweb45}{, 45}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb29}{29}\NWlink{nuweb37c}{, 37c}, \underline{\NWlink{nuweb44}{44}}\NWlink{nuweb45}{, 45}.
\item \verb@wrapperkeyPressHandler@: \underline{\NWlink{nuweb22a}{22a}}\NWlink{nuweb24b}{, 24b}.
\end{list}} 
...
\item \verb@"../src/lib/utils_algo.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb17a}{17a}\NWlink{nuweb17b}{b}\NWlink{nuweb18a}{, 18a}\NWlink{nuweb18b}{b}\NWlink{nuweb19}{, 19}.
}
