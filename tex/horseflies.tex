...
\mbox{}\verb@        horseline, = ax.plot(xhs,yhs,'r-',linewidth=5.0, markersize=6, alpha=1.00)@\\
...
\mbox{}\verb@             if current_fly_posns[i] != None:@\\
...
\mbox{}\verb@    @\\
\mbox{}\verb@             flyline, = ax.plot(xfs, yfs, '-', linewidth=2.5, alpha=1.00, color=color[i])@\\
...
\mbox{}\verb@        debug(Fore.CYAN + "Appending to ims "+ Style.RESET_ALL)@\\
\mbox{}\verb@        ims.append(objs[::-1]) # [::-1] means reverse the list@\\
\mbox{}\verb@@\\
