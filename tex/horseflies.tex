...
\item \NWtxtMacroDefBy\ \NWlink{nuweb27}{27}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}\NWlink{nuweb33a}{, 33a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb22}{22}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}.\item \NWtxtIdentsUsed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb47a}{47a}, \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb47b}{47b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb35a}{} $\langle\,${\itshape Write algorithms current state to file}\nobreak\ {\footnotesize {35a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb36c}{} $\langle\,${\itshape Draw horse and fly-tours}\nobreak\ {\footnotesize {36c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb37a}{} $\langle\,${\itshape Place numbered markers on visited sites to mark the order of visitation explicitly}\nobreak\ {\footnotesize {37a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb37b}{} $\langle\,${\itshape Draw unvisited sites as filled blue circles}\nobreak\ {\footnotesize {37b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb37c}{} $\langle\,${\itshape Give metainformation about current picture as headers and footers}\nobreak\ {\footnotesize {37c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb37d}{} $\langle\,${\itshape Write image file}\nobreak\ {\footnotesize {37d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb38c}{} $\langle\,${\itshape Make an animation of the schedule, if \verb|animate_schedule_p == True|}\nobreak\ {\footnotesize {38c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb38d}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {38d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb39a}{39a}\NWlink{nuweb39b}{b}\NWlink{nuweb40}{, 40}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb33a}{33a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb39b}{39b}\NWlink{nuweb40}{, 40}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb40}{} $\langle\,${\itshape Define auxiliary helper functions}\nobreak\ {\footnotesize {40}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb39a}{39a}\NWlink{nuweb39b}{b}\NWlink{nuweb40}{, 40}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb33a}{33a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@compute_collinear_horseflies_tour@\nobreak\ \NWlink{nuweb42c}{42c}.\item \NWtxtIdentsUsed\nobreak\  \verb@single_site_solution@\nobreak\ \NWlink{nuweb39a}{39a}.
\item{}
\end{list}
\end{minipage}\vspace{4ex}
\end{flushleft}
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb33a}{33a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@self.horse_tour@\nobreak\ \NWlink{nuweb42c}{42c}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb25c}{25c}\NWlink{nuweb25d}{d}\NWlink{nuweb41c}{, 41c}\NWlink{nuweb42a}{, 42a}\NWlink{nuweb42c}{c}, \verb@self.sites,@\nobreak\ \NWlink{nuweb25c}{25c}\NWlink{nuweb25d}{d}, \verb@self.visited_sites,@\nobreak\ \NWlink{nuweb41c}{41c}\NWlink{nuweb42c}{, 42c}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\item \NWtxtIdentsDefed\nobreak\  \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb42a}{42a}\NWlink{nuweb42b}{b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb41d}{} $\langle\,${\itshape Set up tracking variables local to this iteration}\nobreak\ {\footnotesize {41d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ibest                = 0@\\
...
\NWtarget{nuweb42a}{} $\langle\,${\itshape If \texttt{self.sites[u]} is chosen for insertion, find best insertion position and update \texttt{delta\_increase\_least\_table}}\nobreak\ {\footnotesize {42a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroRefIn\ \NWlink{nuweb41b}{41b}.
\item \NWtxtIdentsUsed\nobreak\  \verb@compute_collinear_horseflies_tour_length@\nobreak\ \NWlink{nuweb39b}{39b}, \verb@current_tour_length@\nobreak\ \NWlink{nuweb41c}{41c}, \verb@delta_increase_least@\nobreak\ \NWlink{nuweb41d}{41d}, \verb@delta_increase_least_table@\nobreak\ \NWlink{nuweb41b}{41b}, \verb@ibest,@\nobreak\ \NWlink{nuweb41d}{41d}, \verb@self.inithorseposn,@\nobreak\ \NWlink{nuweb41a}{41a}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb42b}{} $\langle\,${\itshape Find the unvisited site which on insertion increases tour-length by the least amount}\nobreak\ {\footnotesize {42b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb42c}{} $\langle\,${\itshape Update states for \texttt{PolicyBestInsertionNaive}}\nobreak\ {\footnotesize {42c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb45a}{} $\langle\,${\itshape Lower bounds for classic horsefly}\nobreak\ {\footnotesize {45a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\NWtarget{nuweb45b}{} $\langle\,${\itshape Set \verb|phi_prim_mst| to the singleton graph, with node coordinates set at \verb|inithorseposn|}\nobreak\ {\footnotesize {45b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb46a}{} $\langle\,${\itshape For each node in current $\varphi$-Prim-MST compute the closest unmarked site}\nobreak\ {\footnotesize {46a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb46b}{} $\langle\,${\itshape Get the node $M^{*}$ with the closest unmarked site $S^{*}$ from the previous step}\nobreak\ {\footnotesize {46b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb46c}{} $\langle\,${\itshape Compute the rendezvous point $R$ along $M^{*}S^{*}$}\nobreak\ {\footnotesize {46c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\NWtarget{nuweb46d}{} $\langle\,${\itshape Mark site $S$, add node $R$ and edge $MR$ to the existing $\varphi$-Prim-MST}\nobreak\ {\footnotesize {46d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@pass@\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb47a}{47a}\NWlink{nuweb47b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length@\nobreak\ \NWlink{nuweb27}{27}\NWlink{nuweb29}{, 29}\NWlink{nuweb50b}{, 50b}\NWlink{nuweb50c}{c}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb47b}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {47b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb47a}{47a}\NWlink{nuweb47b}{b}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@tour_length_with_waiting_time_included@\nobreak\ \NWlink{nuweb29}{29}\NWlink{nuweb38d}{, 38d}\NWlink{nuweb50b}{, 50b}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb49a}{49a}\NWlink{nuweb51a}{, 51a}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb20a}{20a}.
...
\NWtarget{nuweb49b}{} $\langle\,${\itshape Get x and y coordinates of the endpoints of segments on the horse-tour}\nobreak\ {\footnotesize {49b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb49c}{} $\langle\,${\itshape Get x and y coordinates of the sites}\nobreak\ {\footnotesize {49c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb49d}{} $\langle\,${\itshape Construct the fly-tour from the information about horse tour and sites}\nobreak\ {\footnotesize {49d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@xfs , yfs = [xhs[0]], [yhs[0]]@\\
...
\NWtarget{nuweb49e}{} $\langle\,${\itshape Print information about the horse tour}\nobreak\ {\footnotesize {49e}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@print "\n----------", "\nHorse Tour", "\n-----------"@\\
...
\NWtarget{nuweb50a}{} $\langle\,${\itshape Print information about the fly tour}\nobreak\ {\footnotesize {50a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@print "\n----------", "\nFly Tour", "\n----------"@\\
...
\NWtarget{nuweb50b}{} $\langle\,${\itshape Print meta-data about the algorithm run}\nobreak\ {\footnotesize {50b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@print "----------------------------------"@\\
...
\NWtarget{nuweb50c}{} $\langle\,${\itshape Plot everything}\nobreak\ {\footnotesize {50c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\NWtarget{nuweb51a}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {51a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb51b}{} $\langle\,${\itshape Animation routines for classic horsefly}\nobreak\ {\footnotesize {51b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb52a}{} $\langle\,${\itshape Set up configurations and parameters for animation and plotting}\nobreak\ {\footnotesize {52a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
...
\NWtarget{nuweb52b}{} $\langle\,${\itshape Parse input-output file and set up required data-structures}\nobreak\ {\footnotesize {52b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb53a}{} $\langle\,${\itshape Construct and store every frame of the animation in \verb|ims|}\nobreak\ {\footnotesize {53a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ims = []@\\
...
\NWtarget{nuweb53b}{} $\langle\,${\itshape Render frame and append it to \verb|ims|}\nobreak\ {\footnotesize {53b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb55a}{} $\langle\,${\itshape Define function to place points along a leg}\nobreak\ {\footnotesize {55a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\NWtarget{nuweb55b}{} $\langle\,${\itshape Write animation of schedule to disk and display in live window}\nobreak\ {\footnotesize {55b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
...
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb27}{27}\NWlink{nuweb28}{, 28}\NWlink{nuweb29}{, 29}\NWlink{nuweb33a}{, 33a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$Animation routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb51b}{51b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Compute the rendezvous point $R$ along $M^{*}S^{*}$\nobreak\ {\footnotesize \NWlink{nuweb46c}{46c}}$\,\rangle$ {\footnotesize {\NWtxtNoRef}.}
\item $\langle\,$Construct and store every frame of the animation in \verb|ims|\nobreak\ {\footnotesize \NWlink{nuweb53a}{53a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb51b}{51b}.}
\item $\langle\,$Construct the fly-tour from the information about horse tour and sites\nobreak\ {\footnotesize \NWlink{nuweb49d}{49d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb49a}{49a}.}
\item $\langle\,$Define auxiliary helper functions\nobreak\ {\footnotesize \NWlink{nuweb39a}{39a}\NWlink{nuweb39b}{b}\NWlink{nuweb40}{, 40}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb33a}{33a}.}
\item $\langle\,$Define function to place points along a leg\nobreak\ {\footnotesize \NWlink{nuweb55a}{55a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb53a}{53a}.}
...
\item $\langle\,$Draw horse and fly-tours\nobreak\ {\footnotesize \NWlink{nuweb36c}{36c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb35b}{35b}.}
...
\item $\langle\,$For each node in current $\varphi$-Prim-MST compute the closest unmarked site\nobreak\ {\footnotesize \NWlink{nuweb46a}{46a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb45a}{45a}.}
...
\item $\langle\,$Get the node $M^{*}$ with the closest unmarked site $S^{*}$ from the previous step\nobreak\ {\footnotesize \NWlink{nuweb46b}{46b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb45a}{45a}.}
...
\item $\langle\,$Get x and y coordinates of the sites\nobreak\ {\footnotesize \NWlink{nuweb49c}{49c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb49a}{49a}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb47a}{47a}\NWlink{nuweb47b}{b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
\item $\langle\,$Lower bounds for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb45a}{45a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Make an animation of the schedule, if \verb|animate_schedule_p == True|\nobreak\ {\footnotesize \NWlink{nuweb38c}{38c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb33a}{33a}.}
...
\item $\langle\,$Parse input-output file and set up required data-structures\nobreak\ {\footnotesize \NWlink{nuweb52b}{52b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb51b}{51b}.}
...
\item $\langle\,$Plot everything\nobreak\ {\footnotesize \NWlink{nuweb50c}{50c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb49a}{49a}.}
\item $\langle\,$Plotting routines for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb49a}{49a}\NWlink{nuweb51a}{, 51a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb20a}{20a}.}
...
\item $\langle\,$Print information about the horse tour\nobreak\ {\footnotesize \NWlink{nuweb49e}{49e}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb49a}{49a}.}
...
\item $\langle\,$Render frame and append it to \verb|ims|\nobreak\ {\footnotesize \NWlink{nuweb53b}{53b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb53a}{53a}.}
\item $\langle\,$Return horsefly tour, along with additional information\nobreak\ {\footnotesize \NWlink{nuweb38d}{38d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb33a}{33a}.}
...
\item $\langle\,$Set up configurations and parameters for animation and plotting\nobreak\ {\footnotesize \NWlink{nuweb52a}{52a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb51b}{51b}.}
...
\item $\langle\,$Set up tracking variables local to this iteration\nobreak\ {\footnotesize \NWlink{nuweb41d}{41d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb41b}{41b}.}
...
\item $\langle\,$Write animation of schedule to disk and display in live window\nobreak\ {\footnotesize \NWlink{nuweb55b}{55b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb51b}{51b}.}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb22}{22}\NWlink{nuweb27}{, 27}\NWlink{nuweb28}{, 28}, \underline{\NWlink{nuweb29}{29}}.
\item \verb@algo_greedy_incremental_insertion,@: \NWlink{nuweb22}{22}, \underline{\NWlink{nuweb33a}{33a}}.
...
\item \verb@compute_collinear_horseflies_tour@: \underline{\NWlink{nuweb40}{40}}\NWlink{nuweb42c}{, 42c}.
\item \verb@compute_collinear_horseflies_tour_length@: \underline{\NWlink{nuweb39b}{39b}}\NWlink{nuweb41c}{, 41c}\NWlink{nuweb42a}{, 42a}.
\item \verb@current_tour_length@: \underline{\NWlink{nuweb41c}{41c}}\NWlink{nuweb42a}{, 42a}.
\item \verb@delta_increase_least@: \underline{\NWlink{nuweb41d}{41d}}\NWlink{nuweb42a}{, 42a}.
\item \verb@delta_increase_least_table@: \underline{\NWlink{nuweb41b}{41b}}\NWlink{nuweb42a}{, 42a}\NWlink{nuweb42b}{b}.
...
\item \verb@ibest,@: \underline{\NWlink{nuweb41d}{41d}}\NWlink{nuweb42a}{, 42a}.
\item \verb@io_file_name,@: \underline{\NWlink{nuweb33b}{33b}}\NWlink{nuweb38a}{, 38a}.
\item \verb@logger@: \NWlink{nuweb21a}{21a}, \underline{\NWlink{nuweb33b}{33b}}.
\item \verb@number_of_sites_serviced@: \underline{\NWlink{nuweb53a}{53a}}\NWlink{nuweb53b}{, 53b}.
\item \verb@plotTour@: \NWlink{nuweb22}{22}, \underline{\NWlink{nuweb49a}{49a}}.
\item \verb@self.horse_tour@: \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb42c}{, 42c}.
\item \verb@self.inithorseposn,@: \NWlink{nuweb25c}{25c}\NWlink{nuweb25d}{d}, \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb41c}{, 41c}\NWlink{nuweb42a}{, 42a}\NWlink{nuweb42c}{c}.
\item \verb@self.sites,@: \NWlink{nuweb25c}{25c}\NWlink{nuweb25d}{d}, \underline{\NWlink{nuweb41a}{41a}}.
\item \verb@self.visited_sites,@: \underline{\NWlink{nuweb41a}{41a}}\NWlink{nuweb41c}{, 41c}\NWlink{nuweb42c}{, 42c}.
\item \verb@single_site_solution@: \underline{\NWlink{nuweb39a}{39a}}\NWlink{nuweb39b}{, 39b}\NWlink{nuweb40}{, 40}.
\item \verb@tour_length@: \NWlink{nuweb27}{27}\NWlink{nuweb29}{, 29}, \underline{\NWlink{nuweb47a}{47a}}\NWlink{nuweb50b}{, 50b}\NWlink{nuweb50c}{c}.
\item \verb@tour_length_with_waiting_time_included@: \NWlink{nuweb29}{29}\NWlink{nuweb38d}{, 38d}, \underline{\NWlink{nuweb47b}{47b}}\NWlink{nuweb50b}{, 50b}.
\item \verb@unmarked_sites_idxs@: \underline{\NWlink{nuweb45a}{45a}}\NWlink{nuweb46a}{, 46a}.
