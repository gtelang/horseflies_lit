...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb31}{31}\NWlink{nuweb32}{, 32}\NWlink{nuweb34}{, 34}\NWlink{nuweb38}{, 38}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb24a}{24a}.
\item \NWtxtIdentsUsed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb34}{34}.
\item{}
\end{list}
...
\item \NWtxtMacroDefBy\ \NWlink{nuweb31}{31}\NWlink{nuweb32}{, 32}\NWlink{nuweb34}{, 34}\NWlink{nuweb38}{, 38}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb24a}{24a}.
\item \NWtxtIdentsDefed\nobreak\  \verb@algo_exact_given_specific_ordering@\nobreak\ \NWlink{nuweb26}{26}\NWlink{nuweb31}{, 31}\NWlink{nuweb32}{, 32}.
\item{}
\end{list}
\vspace{4ex}
\end{flushleft}
...
\NWtarget{nuweb38}{} $\langle\,${\itshape Algorithms for classic horsefly}\nobreak\ {\footnotesize {38}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@    @\\
...
\mbox{}\verb@         @\hbox{$\langle\,${\itshape Find the cheapest unvisited site to insert into current ordering of visited sites}\nobreak\ {\footnotesize \NWlink{nuweb40c}{40c}}$\,\rangle$}\verb@@\\
...
\mbox{}\verb@         @\hbox{$\langle\,${\itshape Write algorithm state to file}\nobreak\ {\footnotesize \NWlink{nuweb41a}{41a}}$\,\rangle$}\verb@@\\
\mbox{}\verb@@\\
...
the \verb|.adoc| file will be converted to an HTML file via asciidoctor-latex. 
...
\NWtarget{nuweb39a}{} $\langle\,${\itshape Set log and input-output file config}\nobreak\ {\footnotesize {39a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb39b}{} $\langle\,${\itshape Set insertion policy for current run}\nobreak\ {\footnotesize {39b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@if insertion_policy_name == 'naive':@\\
\mbox{}\verb@         insertion_policy = policy_naive@\\
\mbox{}\verb@else: @\\
\mbox{}\verb@         sys.exit("Unknown insertion policy: " +\@\\
\mbox{}\verb@                   insertion_policy_name)@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
\footnotesize
...
\NWtarget{nuweb39c}{} $\langle\,${\itshape Initialize data-structures}\nobreak\ {\footnotesize {39c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb40a}{} $\langle\,${\itshape Define various insertion policies}\nobreak\ {\footnotesize {40a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@     def policy_naive():@\\
\mbox{}\verb@          pass@\\
\mbox{}\verb@@{\NWsep}
\end{list}
\vspace{-1.5ex}
...
\NWtarget{nuweb40b}{} $\langle\,${\itshape There is at-least one unvisited site}\nobreak\ {\footnotesize {40b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb40c}{} $\langle\,${\itshape Find the cheapest unvisited site to insert into current ordering of visited sites}\nobreak\ {\footnotesize {40c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb40d}{} $\langle\,${\itshape Update list of visited and unvisited sites}\nobreak\ {\footnotesize {40d}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb41a}{} $\langle\,${\itshape Write algorithm state to file}\nobreak\ {\footnotesize {41a}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@@{\NWsep}
...
\NWtarget{nuweb41b}{} $\langle\,${\itshape Write input and output to file}\nobreak\ {\footnotesize {41b}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
\mbox{}\verb@  @{\NWsep}
...
\NWtarget{nuweb41c}{} $\langle\,${\itshape Return horsefly tour, along with additional information}\nobreak\ {\footnotesize {41c}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@@\\
\mbox{}\verb@   @\\
...
\NWtarget{nuweb42}{} $\langle\,${\itshape Local utility functions for classic horsefly}\nobreak\ {\footnotesize {42}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@   @\\
...
\footnotesize
\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \NWtxtMacroDefBy\ \NWlink{nuweb42}{42}\NWlink{nuweb43}{, 43}.
\item \NWtxtMacroRefIn\ \NWlink{nuweb24a}{24a}.
...
\NWtarget{nuweb44}{} $\langle\,${\itshape Plotting routines for classic horsefly}\nobreak\ {\footnotesize {44}}$\,\rangle\equiv$
\vspace{-1ex}
\begin{list}{}{} \item
\mbox{}\verb@ @\\
...
\item \verb@"../main.py"@ {\footnotesize {\NWtxtDefBy} \NWlink{nuweb14}{14}.}
...
{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item $\langle\,$Algorithms for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb31}{31}\NWlink{nuweb32}{, 32}\NWlink{nuweb34}{, 34}\NWlink{nuweb38}{, 38}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb24a}{24a}.}
...
\item $\langle\,$Define various insertion policies\nobreak\ {\footnotesize \NWlink{nuweb40a}{40a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
\item $\langle\,$Find the cheapest unvisited site to insert into current ordering of visited sites\nobreak\ {\footnotesize \NWlink{nuweb40c}{40c}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
...
\item $\langle\,$Local utility functions for classic horsefly\nobreak\ {\footnotesize \NWlink{nuweb42}{42}\NWlink{nuweb43}{, 43}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb24a}{24a}.}
...
\item $\langle\,$Update list of visited and unvisited sites\nobreak\ {\footnotesize \NWlink{nuweb40d}{40d}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
\item $\langle\,$Write algorithm state to file\nobreak\ {\footnotesize \NWlink{nuweb41a}{41a}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
\item $\langle\,$Write input and output to file\nobreak\ {\footnotesize \NWlink{nuweb41b}{41b}}$\,\rangle$ {\footnotesize {\NWtxtRefIn} \NWlink{nuweb38}{38}.}
\end{list}}
\chapter{Index of Identifiers}

{\small\begin{list}{}{\setlength{\itemsep}{-\parsep}\setlength{\itemindent}{-\leftmargin}}
\item \verb@algo_exact_given_specific_ordering@: \NWlink{nuweb26}{26}\NWlink{nuweb31}{, 31}\NWlink{nuweb32}{, 32}, \underline{\NWlink{nuweb34}{34}}.
\item \verb@algo_greedy_incremental_insertion@: \underline{\NWlink{nuweb38}{38}}.
\end{list}} 
